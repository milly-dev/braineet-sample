...
!(function(j) {
    ...
    function E(e) {
        return e.length === 0 ? k.none() : k.some(e[0]);
    }
    function N(e) {
        return e.length === 0 ? k.none() : k.some(e[e.length - 1]);
    }
    var S = function(n) {
        function e() {
            return o;
    ...
    function ue(e, t) {
        for (let n = Nt(e), r = 0, o = n.length; r < o; r++) {
            const i = n[r];
            t(e[i], i);
        }
    }
    ...
    function de(e) {
        const t = Et(e) ? e.dom().parentNode : e.dom();
        return (
    ...
    function ve(e, t) {
        const n = e.dom();
        const r = j.window.getComputedStyle(n).getPropertyValue(t);
        const o = r !== '' || de(e) ? r : Mt(n, t);
    ...
    function be() {
        ...
        return function() {
            ...
            if (t.length !== n.length)
                throw new Error(
                    `Wrong number of arguments to struct. Expected "[${t.length}]", got ${n.length} arguments`,
                );
            const r = {};
            return (
                z(t, function(e, t) {
    ...
    function Ce(e, t, n) {
        return (e.compareDocumentPosition(t) & n) != 0;
    }
    function we(e, t) {
        const n = e.dom();
    ...
    const Ge = {
        ...
        hasAttributeValue(t, n) {
            return function(e) {
                return Fe(e) && e.getAttribute(t) === n;
            };
        },
        matchStyleValues(r, e) {
            const o = e.toLowerCase().split(' ');
            return function(e) {
                let t;
                if (Fe(e))
                    for (t = 0; t < o.length; t++) {
                        const n = e.ownerDocument.defaultView.getComputedStyle(
                            e,
                            null,
                        );
        ...
        isBogusAll(e) {
            return Fe(e) && e.getAttribute('data-mce-bogus') === 'all';
        },
        isTable(e) {
            return Fe(e) && e.tagName === 'TABLE';
        },
    ...
    const ft = function(e, n) {
        return Q(e, n).map(function(e) {
            const t = et.detect(e.versionRegexes, n);
    ...
    const mt = [
        ...
        },
        {
            ...
            search(e) {
                return (
                    (Z(e, 'safari') || Z(e, 'mobile/')) && Z(e, 'applewebkit')
                );
            },
        },
    ];
    ...
    const pt = { browsers: $(mt), oses: $(gt) };
    var vt = Je(
        (function(e, t) {
            const n = pt.browsers();
            const r = pt.oses();
            const o = ft(n, e).fold(rt.unknown, rt.nu);
            const i = dt(r, e).fold(lt.unknown, lt.nu);
            return {
                browser: o,
                os: i,
                deviceType: (function(e, t, n, r) {
                    ...
                    const u = a || r('(pointer:coarse)');
                    const s = o || (!i && a && r('(min-device-width:768px)'));
                    const c = i || (a && !s);
                    const l =
                        t.isSafari() && e.isiOS() && !1 === /safari/i.test(n);
                    const f = !c && !s && !l;
                    return {
                        isiPad: $(o),
                        isiPhone: $(i),
    ...
    var bt = {
        fromHtml(e, t) {
            const n = (t || j.document).createElement('div');
            if (
                ((n.innerHTML = e),
        ...
        fromTag(e, t) {
            const n = (t || j.document).createElement(e);
            return yt(n);
        },
        fromText(e, t) {
            const n = (t || j.document).createTextNode(e);
            return yt(n);
        },
        fromDom: yt,
        fromPoint(e, t, n) {
    ...
    const wt =
        ...
        j.Node.ELEMENT_NODE);
    const xt = j.Node.TEXT_NODE;
    var zt =
        (j.Node.PROCESSING_INSTRUCTION_NODE,
        j.Node.ENTITY_REFERENCE_NODE,
        j.Node.ENTITY_NODE,
        j.Node.NOTATION_NODE,
        typeof j.window !== 'undefined' ? j.window : Function('return this;')(),
        ae(wt));
    var Et = ae(xt);
    var Nt = Object.keys;
    const St = Object.hasOwnProperty;
    var kt = function(e, r) {
        const o = {};
        return (
            ue(e, function(e, t) {
    ...
    const Ht = (be('element', 'offset'), oe().browser);
    const Pt = {
        getPos(e, t, n) {
            let r;
            let o;
            ...
            if (((n = n || e), t)) {
                if (
                    ...
                    ve(bt.fromDom(e), 'position') === 'static'
                )
                    return {
                        x: (i =
                ...
                for (
                    ...
                    (i -= r.scrollLeft || 0),
                        ...
                        (r = r.parentNode);
                a += (function(e) {
                    return Ht.isFirefox() && ie(e) === 'table'
                        ? Be(Re(e))
                              .filter(function(e) {
                                  return ie(e) === 'caption';
                              })
                              .bind(function(o) {
                                  return Be(Me(o)).map(function(e) {
                                      const t = e.dom().offsetTop;
                                      const n = o.dom().offsetTop;
                                      const r = o.dom().offsetHeight;
                                      return t <= n ? -r : 0;
                                  });
                              })
                              .getOr(0)
    ...
    (Pe = undefined),
        ...
        (Ie = undefined),
        (function(e) {
            typeof Le === 'object' && void 0 !== Ve
                ? (Ve.exports = e())
                : typeof Pe === 'function' && Pe.amd
                ? Pe([], e)
            ...
            return (function l(i, a, u) {
                ...
                for (
                    var c = typeof Ie === 'function' && Ie, e = 0;
                    e < u.length;
                    e++
                )
                    s(u[e]);
    ...
    const en = window.Promise
        ...
        : ((Ut =
          ...
          (jt =
              nn.immediateFn ||
              (typeof j.setImmediate === 'function' && j.setImmediate) ||
              function(e) {
                  j.setTimeout(e, 1);
              }),
          ...
          (nn.all = function() {
              const s = Array.prototype.slice.call(
                  arguments.length === 1 && Ut(arguments[0])
                      ? arguments[0]
                      : arguments,
              );
              return new nn(function(o, i) {
                  ...
                  for (let e = 0; e < s.length; e++) u(e, s[e]);
              });
          }),
          (nn.resolve = function(t) {
              return t && typeof t === 'object' && t.constructor === nn
                  ? t
                  : new nn(function(e) {
                        e(t);
                    });
          ...
          (nn.race = function(o) {
              return new nn(function(e, t) {
                  for (let n = 0, r = o.length; n < r; n++) o[n].then(e, t);
              });
          }),
          nn);
    function tn(e, t) {
    ...
    function rn(r) {
        ...
        this._state !== null
            ? jt(function() {
                  const e = o._state ? r.onFulfilled : r.onRejected;
                  if (e !== null) {
                      let t;
                      try {
                          t = e(o._value);
    ...
    function un() {
        for (let e = 0, t = this._deferreds.length; e < t; e++)
    ...
    function ln(e, t) {
        return typeof t !== 'number' && (t = 0), j.setTimeout(e, t);
    }
    function fn(e, t) {
        return typeof t !== 'number' && (t = 1), j.setInterval(e, t);
    }
    function dn(n, r) {
        let o;
        let e;
    ...
    function gn(e) {
        return e === null || e === undefined ? '' : `${e}`.replace(An, '');
    }
    function pn(e, t) {
        return t
            ? !(t !== 'array' || !Tn.isArray(e)) || typeof e === t
            : e !== undefined;
    }
    const vn = {
        requestAnimationFrame(e, t) {
            qt
                ...
                : (qt = new en(function(e) {
                      !(function(e, t) {
                          let n;
                          let r = j.window.requestAnimationFrame;
                          const o = ['ms', 'moz', 'webkit'];
    ...
    const yn = j.navigator.userAgent;
    const bn = oe();
    const Cn = bn.browser;
    const wn = bn.os;
    const xn = bn.deviceType;
    const zn = /WebKit/.test(yn) && !Cn.isEdge();
    const En =
        'FormData' in j.window &&
        'FileReader' in j.window &&
        'URL' in j.window &&
        !!j.URL.createObjectURL;
    const Nn = yn.indexOf('Windows Phone') !== -1;
    const Sn = {
        opera: Cn.isOpera(),
        webkit: zn,
    ...
    const Un = Dn(['ul', 'ol', 'dl']);
    const jn = Dn(['li', 'dd', 'dt']);
    const qn = Dn([
        'area',
        'base',
        'basefont',
    ...
    const $n = Dn(['thead', 'tbody', 'tfoot']);
    const Wn = Dn(['td', 'th']);
    const Kn = Dn(['pre', 'script', 'textarea', 'style']);
    var Xn = function(e, t) {
        let n;
        let r = t.childNodes;
        if (!Ge.isElement(t) || !Bn(t)) {
            for (n = r.length - 1; n >= 0; n--) Xn(e, r[n]);
            if (!1 === Ge.isDocument(t)) {
                if (Ge.isText(t) && t.nodeValue.length > 0) {
                    const o = Rn.trim(t.nodeValue).length;
                    ...
                    if (
                        ...
                        (function(e) {
                            const t =
                                e.previousSibling &&
                                e.previousSibling.nodeName === 'SPAN';
                            const n =
                                e.nextSibling &&
                                e.nextSibling.nodeName === 'SPAN';
                            return t && n;
                        })(t)
                    )
                        return;
    ...
    const Yn = { trimNode: Xn };
    const Gn = Rn.makeMap;
    const Jn = /[&<>\"\u0060\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g;
    const Qn = /[<>&\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g;
    const Zn = /[<>&\"\']/g;
    const er = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi;
    const tr = {
        128: '\u20ac',
        130: '\u201a',
        131: '\u0192',
        ...
        return ur[e]
            ...
            : ((u = 'id accesskey class dir lang style tabindex title role'),
              ...
              e !== 'html5-strict' &&
                  ...
                  (o = [
                      o,
                      (s = 'acronym applet basefont big font strike tt'),
                  ].join(' ')),
                  lr(mr(s), function(e) {
                      t(e, '', o);
                  }),
    ...
    function wr(e, t) {
        ...
        if (
            ...
            const o = r.target.ownerDocument || j.document;
        ...
        return (
            ...
            typeof r.metaKey === 'undefined' && (r.metaKey = !1),
            r
        );
    }
    function xr(e, t, n) {
        ...
        if (n.domLoaded) t(o);
            ...
            (r.readyState === 'interactive' && r.body)
                ? i()
                : br(e, 'DOMContentLoaded', i),
                br(e, 'load', i);
        }
    }
    const zr = function(b, e) {
        let C;
        let t;
        let c;
        let l;
        const w = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi;
        const x = /(?:url(?:(?:\(\s*\"([^\"]+)\"\s*\))|(?:\(\s*\'([^\']+)\'\s*\))|(?:\(\s*([^)\s]+)\s*\))))|(?:\'([^\']+)\')|(?:\"([^\"]+)\")/gi;
        const z = /\s*([^:]+):\s*([^;]+);?/g;
        const E = /\s+$/;
        const N = {};
        const S = '\ufeff';
        ...
        return {
            ...
            parse(e) {
                ...
                let g;
                var p = {};
                var v = b.url_converter;
                var y = b.url_converter_scope || this;
                if (e) {
                    for (
                        e = (e = e.replace(/[\u0000-\u001F]/g, ''))
                            .replace(/\\[\"\';:\uFEFF]/g, r)
                    ...
                    t('border', '', !0),
                        ...
                        n((h = 'border-width')) &&
                            ...
                            delete p[m],
                            delete p[g]),
                        p.border === 'medium none' && delete p.border,
                        p['border-image'] === 'none' &&
                            delete p['border-image'];
                }
                return p;
            },
            serialize(i, e) {
    ...
    var Er = /^(?:mouse|contextmenu)|click/;
    var Nr = {
        keyLocation: 1,
        layerX: 1,
        layerY: 1,
    ...
    const Tr =
        ((Ar.prototype.bind = function(e, t, n, r) {
            ...
            if (e && e.nodeType !== 3 && e.nodeType !== 8) {
                ...
                for (u = m.length; u--; )
                    (l = o),
                        (c = f = !1),
                        (s = m[u]) === 'DOMContentLoaded' && (s = 'ready'),
                        d.domLoaded &&
                        s === 'ready' &&
                        e.readyState === 'complete'
                            ...
                            : (d.hasMouseEnterLeave ||
                              ...
                              d.hasFocusIn ||
                                  (s !== 'focusin' && s !== 'focusout') ||
                                  ((f = !0),
                                  (c = s === 'focusin' ? 'focus' : 'blur'),
                                  (l = function(e) {
                                      ((e = wr(e || h.event)).type =
                                          e.type === 'focus'
                                              ? 'focusin'
        ...
        (Ar.prototype.unbind = function(e, t, n) {
            ...
            let u;
            let s;
            if (!e || e.nodeType === 3 || e.nodeType === 8) return this;
            if ((r = e[this.expando])) {
    ...
    function Ar() {
        (this.domLoaded = !1),
            ...
            (this.hasMouseEnterLeave =
                'onmouseenter' in j.document.documentElement),
    ...
    let Kr;
    let Xr;
    const Yr = `sizzle${-new Date()}`;
    const Gr = j.window.document;
    let Jr = 0;
    let Qr = 0;
    const Zr = Ro();
    const eo = Ro();
    ...
    const fo = '[\\x20\\t\\r\\n\\f]';
    const ho = '(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+';
    const mo = `\\[${fo}*(${ho})(?:${fo}*([*^$|!~]?=)${fo}*(?:'((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)"|(${ho}))|)${fo}*\\]`;
    const go = `:(${ho})(?:\\((('((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|${mo})*)|.*)\\)|)`;
    const po = new RegExp(`^${fo}+|((?:^|[^\\\\])(?:\\\\.)*)${fo}+$`, 'g');
    const vo = new RegExp(`^${fo}*,${fo}*`);
    const yo = new RegExp(`^${fo}*([>+~]|${fo})${fo}*`);
    const bo = new RegExp(`=${fo}*([^\\]'"]*?)${fo}*\\]`, 'g');
    const Co = new RegExp(go);
    const wo = new RegExp(`^${ho}$`);
    const xo = {
        ID: new RegExp(`^#(${ho})`),
        CLASS: new RegExp(`^\\.(${ho})`),
        TAG: new RegExp(`^(${ho}|[*])`),
        ...
        CHILD: new RegExp(
            `^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(${fo}*(even|odd|(([+-]|)(\\d*)n|)${fo}*(?:([+-]|)${fo}*(\\d+)|))${fo}*\\)|)`,
            'i',
        ),
        bool: new RegExp(
        ...
        needsContext: new RegExp(
            `^${fo}*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(${fo}*((?:-\\d)?\\d*)${fo}*\\)|)(?=[^-]|$)`,
            'i',
        ),
    };
    const zo = /^(?:input|select|textarea|button)$/i;
    const Eo = /^h\d$/i;
    const No = /^[^{]+\{\s*\[native \w/;
    const So = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/;
    const ko = /[+~]/;
    const To = /'|\\/g;
    const Ao = new RegExp(`\\\\([\\da-f]{1,6}${fo}?|(${fo})|.)`, 'ig');
    try {
    ...
    const Mo = function(e, t, n, r) {
        ...
        if (
            ...
            return n;
        if ((u = (t = t || jr).nodeType) !== 1 && u !== 9) return [];
        if ($r && !r) {
            if ((o = So.exec(e)))
                if ((a = o[1])) {
                    if (u === 9) {
            ...
            if (Dr.qsa && (!Wr || !Wr.test(e))) {
                if (
                    ...
                    (d = t),
                    (h = u === 9 && e),
                    u === 1 && t.nodeName.toLowerCase() !== 'object')
                ) {
                    for (
                        c = Hr(e),
                            (l = t.getAttribute('id'))
    ...
    (Br = Mo.isXML = function(e) {
        const t = e && (e.ownerDocument || e).documentElement;
        return !!t && t.nodeName !== 'HTML';
    }),
    (Ur = Mo.setDocument = function(e) {
        let t;
        const s = e ? e.ownerDocument || e : Gr;
        const n = s.defaultView;
        return s !== jr && s.nodeType === 9 && s.documentElement
                  ...
                  ? function(e, t) {
                        ...
                        return (
                            ...
                            (!Dr.sortDetached &&
                                ...
                                ? e === s ||
                                  (e.ownerDocument === Gr && Xr(Gr, e))
                                    ? -1
                                    : t === s ||
                                      (t.ownerDocument === Gr && Xr(Gr, t))
                                    ? 1
                                    : Ir
    ...
    (Mo.matchesSelector = function(e, t) {
        ...
        return Mo(t, jr, null, [e]).length > 0;
    }),
    ...
    (Mo.attr = function(e, t) {
        (e.ownerDocument || e) !== jr && Ur(e);
        const n = _r.attrHandle[t.toLowerCase()];
        let r =
            n && oo.call(_r.attrHandle, t.toLowerCase())
                ? n(e, t, !$r)
                : undefined;
        return r !== undefined
            ? r
    ...
    ((_r = Mo.selectors = {
        ...
        filter: {
            TAG(e) {
                const t = e.replace(Ao, Mr).toLowerCase();
                return e === '*'
                    ? function() {
                          return !0;
                      }
            ...
            CHILD(h, e, t, m, g) {
                const p = h.slice(0, 3) !== 'nth';
                const v = h.slice(-4) !== 'last';
                const y = e === 'of-type';
                return m === 1 && g === 0
                    ? function(e) {
                          return !!e.parentNode;
                    ...
                    : function(e, t, n) {
                          ...
                          let u;
                          let s;
                          let c = p != v ? 'nextSibling' : 'previousSibling';
                          const l = e.parentNode;
                          const f = y && e.nodeName.toLowerCase();
                          const d = !n && !y;
                          if (l) {
                              if (p) {
                                  for (; c; ) {
        ...
        pseudos: {
            ...
            contains: Do(function(t) {
                return (
                    ...
                    function(e) {
                        return (
                            (e.textContent || e.innerText || Or(e)).indexOf(t) >
                            -1
                        );
                    }
                );
            ...
            target(e) {
                const t = j.window.location && j.window.location.hash;
    ...
    function Io(a, e, t) {
        const u = e.dir;
        const s = t && u === 'parentNode';
        const c = Qr++;
        return e.first
            ? function(e, t, n) {
                  for (; (e = e[u]); )
                      if (e.nodeType === 1 || s) return a(e, t, n);
              }
            : function(e, t, n) {
                  let r;
                  let o;
                  ...
                  if (n) {
                      for (; (e = e[u]); )
                          if ((e.nodeType === 1 || s) && a(e, t, n)) return !0;
                  } else
                      for (; (e = e[u]); )
                          if (e.nodeType === 1 || s) {
                              if (
    ...
    function Fo(o) {
        return o.length > 1
            ? function(e, t, n) {
                  for (let r = o.length; r--; ) if (!o[r](e, t, n)) return !1;
                  return !0;
              }
            : o[0];
    }
    function Uo(e, t, n, r, o) {
        for (var i, a = [], u = 0, s = e.length, c = t != null; u < s; u++)
    ...
    function jo(m, g, p, v, y, e) {
        return (
            ...
            Do(function(e, t, n, r) {
                ...
                const f = !m || (!e && g) ? l : Uo(l, u, m, n, r);
                let d = p ? (y || (e ? m : c || v) ? [] : t) : f;
                if ((p && p(f, d, n, r), v))
                ...
                (i = to(
                    ...
                    (function a(p, v) {
                        function e(e, t, n, r, o) {
                            ...
                            let f = [];
                            const d = Vr;
                            const h = e || (b && _r.find.TAG('*', o));
                            const m = (Jr +=
                                d == null ? 1 : Math.random() || 0.1);
                            const g = h.length;
                            for (
                                o && (Vr = t !== jr && t);
                                c !== g && (i = h[c]) != null;
        ...
        (Lr = Mo.select = function(e, t, n, r) {
            ...
            if (((n = n || []), l.length === 1)) {
                if (
                    ...
                    if (
                        !(t = (_r.find.ID(a.matches[0].replace(Ao, Mr), t) ||
                            [])[0])
                    )
                        return n;
                    c && (t = t.parentNode),
    ...
    function Jo(e) {
        return e === null || e === undefined ? '' : `${e}`.replace(hi, '');
    }
    function Qo(e, t) {
        let n;
        let r;
    ...
    var ei = j.document;
    const ti = Array.prototype.push;
    const ni = Array.prototype.slice;
    const ri = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/;
    const oi = Tr.Event;
    const ii = Rn.makeMap('children,contents,next,prev');
    var ai = function(e, t, n, r) {
        let o;
        if (Wo(t)) t = Ko(t, mi(e[0]));
        else if (t.length && !t.nodeType) {
            if (((t = yi.makeArray(t)), r))
                for (o = t.length - 1; o >= 0; o--) ai(e, t[o], n, r);
    ...
    const ci = { for: 'htmlFor', class: 'className', readonly: 'readOnly' };
    const li = { float: 'cssFloat' };
    const fi = {};
    const di = {};
    var hi = /^\s*|\s*$/g;
    var mi = function(e) {
        return e ? (e.nodeType === 9 ? e : e.ownerDocument) : ei;
    };
    (Go.fn = Go.prototype = {
        constructor: Go,
        selector: '',
        ...
        css(n, r) {
            ...
            if (typeof n === 'object')
                ...
                (n = e(n)),
                    typeof r !== 'number' || ui[n] || (r = `${r.toString()}px`),
                    a.each(function() {
                        const e = this.style;
        ...
        append() {
            return ai(this, arguments, function(e) {
                (this.nodeType === 1 ||
                    (this.host && this.host.nodeType === 1)) &&
                    this.appendChild(e);
            });
        },
        prepend() {
    ...
    function gi(e, t, n) {
        ...
        let o = e[t];
        for (
            typeof n !== 'string' && n instanceof yi && (n = n[0]);
            o && o.nodeType !== 9;

        ) {
            if (n !== undefined) {
                if (o === n) break;
                if (typeof n === 'string' && yi(o).is(n)) break;
            }
    ...
    function pi(e, t, n, r) {
        ...
        for (r instanceof yi && (r = r[0]); e; e = e[t])
            if (!n || e.nodeType === n) {
                if (r !== undefined) {
                    if (e === r) break;
                    if (typeof r === 'string' && yi(e).is(r)) break;
                }
                o.push(e);
            }
        return o;
    ...
    Qo(
        ...
        function(r, o) {
            Go.fn[r] = function(t) {
                let n = [];
                this.each(function() {
                    const e = o.call(n, this, t, n);
                    e && (yi.isArray(e) ? n.push.apply(n, e) : n.push(e));
                }),
                    this.length > 1 &&
                        (ii[r] || (n = yi.unique(n)),
                        r.indexOf('parents') === 0 && (n = n.reverse()));
                const e = yi(n);
        ...
        Qo(
            ...
            function(o, i) {
                Go.fn[o] = function(t, e) {
                    let n = [];
                    this.each(function() {
                        const e = i.call(n, this, t, n);
                        e && (yi.isArray(e) ? n.push.apply(n, e) : n.push(e));
                    }),
                        this.length > 1 &&
                            ((n = yi.unique(n)),
                            (o.indexOf('parents') !== 0 && o !== 'prevUntil') ||
                                (n = n.reverse()));
                    const r = yi(n);
        ...
        (Go.overrideDefaults = function(n) {
            ...
            var o = function(e, t) {
                return (
                    (r = r || n()),
                    arguments.length === 0 && (e = r.element),
                    (t = t || r.context),
                    new o.fn.init(e, t)
                );
            };
    ...
    function Ti(e) {
        const t = e !== undefined ? e.dom() : j.document;
        const n = t.body.scrollLeft || t.documentElement.scrollLeft;
        const r = t.body.scrollTop || t.documentElement.scrollTop;
        return Hi(n, r);
    }
    function Ai(e, t, n) {
    ...
    var Li = oe().browser.isSafari();
    const Vi = function(e) {
        const t = e === undefined ? j.window : e;
        const n = t.document;
        const r = Ti(bt.fromDom(n));
        const o = t.visualViewport;
        if (o !== undefined)
            return Ri(
    ...
    const $i = function(n, r, o) {
        ...
        const t = {
            style: {
                ...
                get(e) {
                    let t = e.attr('data-mce-style') || e.attr('style');
    ...
    const Wi = function(e, t) {
        ...
        let r = e.serialize(e.parse(n), t[0].nodeName);
    ...
    function Xi(a, u) {
        ...
        function f(e) {
            return typeof e === 'string' && (e = l(e)), H(e);
        }
        function r(e, t, n) {
            let r;
            let o;
        ...
        function p(e, t) {
            ...
            return Mo(t, i[0].ownerDocument || i[0], null, i).length > 0;
        }
        function v(e, t, n, r) {
            let o;
            const i = [];
            ...
            for (
                r = r === undefined,
                    n = n || (h().nodeName !== 'BODY' ? h().parentNode : null),
                    Rn.is(t, 'string') &&
                        (t =
                            (o = t) === '*'
                                ? function(e) {
                ...
                a && a !== n && a.nodeType && a.nodeType !== 9;

            ) {
                if (!t || (typeof t === 'function' && t(a))) {
                    if (!r) return [a];
                    i.push(a);
                }
                a = a.parentNode;
        ...
        function n(e, t, n) {
            ...
            if (e)
                for (
                    ...
                    if (typeof r === 'function' && r(e)) return e;
            return null;
        }
        function y(e, n, r) {
            let o;
            ...
            if (!t) return !1;
            if (Rn.isArray(t) && (t.length || t.length === 0))
                return (
                    (o = []),
                    Ii(t, function(e, t) {
                        e &&
        ...
        function w(e, n, r, o, i) {
            return y(e, function(e) {
                const t = typeof n === 'string' ? a.createElement(n) : n;
                return (
                    b(t, r),
                    o &&
                        (typeof o !== 'string' && o.nodeType
                            ? t.appendChild(o)
                            : typeof o === 'string' && C(t, o)),
                    i ? t : e.appendChild(t)
                );
            });
        }
            ...
            function n(e, t, n) {
                function r(e) {
                    (l.status = e),
                        ...
                        (l.failed = []),
                        u &&
                            ((u.onload = null), (u.onerror = null), (u = null));
                }
                function o() {
                    for (let e = l.passed, t = e.length; t--; ) e[t]();
                    r(2);
                }
                function i() {
                    for (let e = l.failed, t = e.length; t--; ) e[t]();
                    r(3);
                }
                function a(e, t) {
                    e() ||
                        (new Date().getTime() - c < p ? vn.setTimeout(t) : i());
                }
                let u;
                let s;
                let c;
                    ...
                    if (l.status !== 2)
                        if (l.status !== 3) {
                            if (
                                ...
                                if (
                                    j.navigator.userAgent.indexOf('Firefox') > 0
                                )
                                    return (
                                        ((s = m.createElement(
                                            'style',
                                        )).textContent = `@import "${e}"`),
                                        d(),
                                        void b(s)
                                    );
                                f();
        ...
        const O = u.ownEvents ? new Tr() : Tr.Event;
        const B = D.getBlockElements();
        var H = yi.overrideDefaults(function() {
            return { context: a, element: F.getRoot() };
        });
        const P = ar.decode;
        const L = ar.encodeAllRaw;
        ...
        var F = {
            ...
            root: null,
            clone(t, e) {
                if (!Ui || t.nodeType !== 1 || e) return t.cloneNode(e);
                if (e) return null;
                const n = a.createElement(t.nodeName);
                return (
                    Ii(d(t), function(e) {
            ...
            createFragment(e) {
                ...
                const r = a.createDocumentFragment();
            ...
            remove: z,
            setStyle(e, t, n) {
                const r = K(t) ? f(e).css(t, n) : f(e).css(t);
            ...
            isEmpty(e, t) {
                ...
                let a = 0;
                if ((e = e.firstChild)) {
                    const u = new bi(e, e.parentNode);
                    const s = D ? D.getWhiteSpaceElements() : {};
                    t = t || (D ? D.getNonEmptyElements() : null);
                    do {
                        if (((o = e.nodeType), Ge.isElement(e))) {
                            const c = e.getAttribute('data-mce-bogus');
                            if (c) {
                                e = u.next(c === 'all');
                                continue;
                            }
                        ...
                        if (o === 8) return !1;
                        if (o === 3 && !qi.test(e.nodeValue)) return !1;
                        if (
                            o === 3 &&
                            e.parentNode &&
        ...
        return {
            ...
            requireLangPack(e, t) {
                ...
                if (n && !1 !== aa.languageLoad) {
                    if (t)
                        if (
                            (t = `,${t},`).indexOf(`,${n.substr(0, 2)},`) !== -1
                        )
                            n = n.substr(0, 2);
                        else if (t.indexOf(`,${n},`) === -1) return;
                    Zi.ScriptLoader.add(`${s[e]}/langs/${n}.js`);
                }
            },
            add(t, e, n) {
                o.push(e), (c[t] = { instance: e, dependencies: n });
                const r = Y(l, function(e) {
                    return e.name === t;
                });
                return (
                    (l = r.fail),
    ...
    function ua(n, r) {
        ...
        return {
            cancel() {
                o !== null && (j.clearTimeout(o), (o = null));
            },
            throttle() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
    ...
    function la(e, t) {
        return (function(e, t, n) {
            const r = sa(e, t).concat([n]);
            return At(e, t, r.join(' ')), !0;
        })(e, 'class', t);
    }
    function fa(e, t) {
        return (function(e, t, n) {
            const r = y(sa(e, t), function(e) {
                return e !== n;
            });
            return r.length > 0 ? At(e, t, r.join(' ')) : pe(e, t), !1;
        })(e, 'class', t);
    }
    function da(e, t) {
    ...
    function ga(e, t) {
        return (function(e, t) {
            const n = t === undefined ? j.document : t.dom();
    ...
    function ba(e, t, n) {
        for (let r = e.dom(), o = D(n) ? n : $(!1); r.parentNode; ) {
            r = r.parentNode;
            const i = bt.fromDom(r);
    ...
    function xa(e, t) {
        return (function(e, t) {
            ...
            return xe(n)
                ? k.none()
                : k.from(n.querySelector(e)).map(bt.fromDom);
        })(t, e);
    }
    function za(e, t, n) {
    ...
    function Ea(r, e) {
        ...
        const n = r.selection.getRng();
        const o = bt.fromDom(n.startContainer);
        const i = bt.fromDom(r.getBody());
        const a = e.fold(
            function() {
                return `.${ru()}`;
            },
        ...
        const u = De(o, n.startOffset).getOr(o);
    ...
    function Ma(e, t) {
        const n = Ee(e).dom();
        const r = bt.fromDom(n.createDocumentFragment());
    ...
    function Ra(e) {
        return (
            hu(e) && (e = e.parentNode),
            du(e) && e.hasAttribute('data-mce-caret')
        );
    }
    function Da(e) {
    ...
    function Pa(e, t, n) {
        ...
        return (
            ...
            r.appendChild(
                (function() {
                    const e = j.document.createElement('br');
    ...
    function Va(e) {
        return (
            !zu(e) &&
            (bu(e) ? !Cu(e.parentNode) : wu(e) || yu(e) || xu(e) || Eu(e))
        );
    }
    function Ia(e, t) {
        return (
    ...
    function $a(e, t) {
        return (
            e.top > t.bottom ||
            (!(e.bottom < t.top) && ja(t.bottom - e.top, e, t))
        );
    }
    function Wa(e, t, n) {
    ...
    function Ya(e) {
        return typeof e === 'string' && e.charCodeAt(0) >= 768 && Su.test(e);
    }
    function Ga(e, t, n) {
    ...
    let nu;
    var ru = $('mce-annotation');
    var ou = $('data-mce-annotation');
    var iu = $('data-mce-annotation-uid');
    var au = function(e, t) {
        const n = bt.fromDom(e.getBody());
        return ga(n, `[${iu()}="${t}"]`);
    };
    let uu = 0;
    const su = '\ufeff';
    ...
    var pu = Ge.isContentEditableTrue;
    const vu = Ge.isContentEditableFalse;
    var yu = Ge.isBr;
    var bu = Ge.isText;
    var Cu = Ge.matchNodeNames(['script', 'style', 'textarea']);
    var wu = Ge.matchNodeNames([
        'img',
        'input',
        'textarea',
        'hr',
    ...
    var xu = Ge.matchNodeNames(['table']);
    var zu = _a;
    var Eu = function(e) {
        return (
            !1 ===
                (function(e) {
                    return (
                        Ge.isElement(e) &&
                        e.getAttribute('unselectable') === 'true'
                    );
                })(e) && vu(e)
        );
    };
    ...
    const ku = [].slice;
    const Tu = function() {
        for (let e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        const n = ku.call(arguments);
        return function(e) {
    ...
    const Mu = Ge.isElement;
    const Ru = Va;
    const Du = Ge.matchStyleValues('display', 'block table');
    const _u = Ge.matchStyleValues('float', 'left right');
    const Ou = Tu(Mu, Ru, s(_u));
    var Bu = s(Ge.matchStyleValues('white-space', 'pre pre-line pre-wrap'));
    const Hu = Ge.isText;
    const Pu = Ge.isBr;
    const Lu = Yi.nodeIndex;
    const Vu = Xa;
    const Iu = function(e) {
    ...
    function ju(t, n, e) {
        ...
        return {
            ...
            toRange() {
                let e;
                return (
                    (e = Iu(t.ownerDocument)).setStart(t, n), e.setEnd(t, n), e
                );
            },
            getClientRects: r,
            isVisible() {
    ...
    ((nu = ju = ju || {}).fromRangeStart = function(e) {
        ...
        (nu.isAbove = function(e, t) {
            return Ga(E(t.getClientRects()), N(e.getClientRects()), qa).getOr(
                !1,
            );
        }),
        (nu.isBelow = function(e, t) {
            return Ga(N(t.getClientRects()), E(e.getClientRects()), $a).getOr(
                !1,
            );
        }),
            ...
            ? ((t = (n = t.split(','))[0].split('/')),
              ...
              (r = Tn.reduce(
                          ...
                          ? (t[1] === 'text()' && (t[1] = '#text'),
                            (function(e, t, n) {
                                ...
                                return (
                                    ...
                                    (r = Tn.filter(r, Ge.matchNodeNames([t])))[
                                        n
                                    ]
                                );
                  ...
                  ? Os(r)
                      ...
                      : ((o = o === 'after' ? Hs(r) + 1 : Hs(r)),
                        _s(r.parentNode, o))
                  : null)
            : null;
    }
    function Xu(e, t) {
        Ge.isText(t) && t.data.length === 0 && e.remove(t);
    }
    function Yu(e, t, n) {
        Ge.isDocumentFragment(n)
            ? (function(t, e, n) {
                  const r = k.from(n.firstChild);
                  const o = k.from(n.lastChild);
                  e.insertNode(n),
                      r.each(function(e) {
            ...
            : (function(e, t, n) {
                  t.insertNode(n),
                      Xu(e, n.previousSibling),
                      Xu(e, n.nextSibling);
              })(e, t, n);
    }
    function Gu(e, t, n, r, o) {
        let i;
        let a = r[o ? 'startContainer' : 'endContainer'];
        let u = r[o ? 'startOffset' : 'endOffset'];
        const s = [];
        let c = 0;
        const l = e.getRoot();
        for (
    ...
    function Ju(e, t, n) {
        ...
        return (
            Rn.each(e.select(t), function(e) {
                if (e.getAttribute('data-mce-bogus') !== 'all')
                    return e !== n && void r++;
            }),
            r
        );
    ...
    function ts(e, t, n) {
        const r = n.getNode();
        let o = r ? r.nodeName : null;
        const i = n.getRng();
        if (Vs(r) || o === 'IMG') return { name: o, index: Ju(n.dom, o, r) };
        const a = (function(e) {
            return (
                es(e.startContainer, e.startOffset) ||
                es(e.endContainer, e.endOffset)
            );
        })(i);
        return a
    ...
    function rs(e, t) {
        ...
        let r = e.getRng();
        const o = n.uniqueId();
        const i = e.isCollapsed();
        const a = e.getNode();
        const u = a.nodeName;
        if (u === 'IMG') return { name: u, index: Ju(n, u, a) };
        const s = Zu(r.cloneRange());
        if (!i) {
            s.collapse(!1);
            const c = ns(n, `${o}_end`, t);
            Yu(n, s, c);
        }
        (r = Zu(r)).collapse(!0);
        const l = ns(n, `${o}_start`, t);
    ...
    function fs(e, t) {
        return js(e) && t.container() === e
            ? (function(e, t) {
                  const n = ss(e.data.substr(0, t.offset()));
                  const r = ss(e.data.substr(t.offset()));
                  const o = n.text + r.text;
                  return o.length > 0
                      ? (us(e, o), _s(e, t.offset() - n.count))
                      : t;
              })(e, t)
            : cs(e, t);
    }
    function ds(e, t, n) {
        ...
        let a;
        let u;
        const s = Ua(t.getBoundingClientRect(), n);
        return (
            (i =
                e.tagName === 'BODY'
    ...
    function hs(i, a, e) {
        ...
        const c = function() {
            !(function(e) {
                ...
                let i;
                for (
                    t = yi('*[contentEditable=false]', e), o = 0;
                    o < t.length;
                    o++
                )
        ...
        const l = function() {
            t = vn.setInterval(function() {
                e()
                    ...
                    : yi('div.mce-visual-caret', i).addClass(
                          'mce-visual-caret-hidden',
                      );
            }, 500);
        };
        return {
            ...
            reposition() {
                s.get().each(function(e) {
                    const t = ds(i, e.element, e.before);
                    yi(e.caret).css({ ...t });
                });
            },
            destroy() {
    ...
    function Ns(e, t, n) {
        ...
        if (((o = n.startContainer), (i = n.startOffset), Ra(o))) {
            if (
                (Qs(o) || (o = o.parentNode),
                (a = o.getAttribute('data-mce-caret')) === 'before' &&
                    ((r = o.nextSibling), gs(r)))
            )
                return ec(r);
            if (a === 'after' && ((r = o.previousSibling), gs(r))) return tc(r);
        }
        ...
        if (Ge.isText(o)) {
            ...
            if (gu(o) && i >= o.data.length - 1)
                return e === 1 && (r = s(o)) ? ec(r) : n;
            if (mu(o) && i <= 1) return e === -1 && (r = u(o)) ? tc(r) : n;
            if (i === o.data.length) return (r = s(o)) ? ec(r) : n;
            if (i === 0) return (r = u(o)) ? tc(r) : n;
        }
        return n;
    }
    function Ss(e, t) {
    ...
    function ks(e, t, n) {
        const r = Ns(e, t, n);
        return e === -1 ? ju.fromRangeStart(r) : ju.fromRangeEnd(r);
    }
    function Ts(e) {
    ...
    var Vs = Ge.isContentEditableFalse;
    const Is = {
        getBookmark(e, t, n) {
            return t === 2
                ? ts(fu, n, e)
    ...
    var Ws = oe().browser;
    var Ks = Ge.isContentEditableFalse;
    var Xs = Ge.isContentEditableFalse;
    var Ys = Ge.matchStyleValues(
        'display',
    ...
    function rc(e, t) {
        if (ps(e)) {
            if (Mc(t.previousSibling) && !kc(t.previousSibling))
                return _s.before(t);
    ...
    function ic(e) {
        return _s.isTextPosition(e) ? e.offset() === 0 : Va(e.getNode());
    }
    function ac(e) {
    ...
    function lc(e, t) {
        ...
        return Ge.isText(n)
            ...
            ? Va(n)
                ...
                : (function(e, t, n) {
                      const r = e ? _s.before(n) : _s.after(n);
                      return Oc(e, t, r);
                  })(e, t, n)
            : k.none();
    }
    ...
    function hc(e, t, n) {
        return (
            ...
            ((function(e, t) {
                const n = e.ownerDocument.createTextNode(lu);
    ...
    function mc(e, t, n, r) {
        ...
        if (s) {
            ...
            i.nodeType === 3 && (a = Math.min(s[0], i.nodeValue.length)),
                i.nodeType === 1 && (a = Math.min(s[0], i.childNodes.length)),
                t ? r.setStart(i, a) : r.setEnd(i, a);
        }
        return !0;
    }
    function gc(e) {
        return Ge.isText(e) && e.data.length > 0;
    }
    function pc(e, t, n) {
        let r;
        let o;
    ...
    function yc(e, t, n) {
        return (
            (n !== 'color' && n !== 'backgroundColor') || (t = e.toHex(t)),
            n === 'fontWeight' && t === 700 && (t = 'bold'),
            n === 'fontFamily' &&
    ...
    function Cc(e, t) {
        for (let n = t; n; ) {
            if (n.nodeType === 1 && e.getContentEditable(n))
    ...
    function wc(e, t, n, r) {
        ...
        return (
            ...
            e
                ? ((o = a.lastIndexOf(' ', r)),
                  (o = (i = a.lastIndexOf('\xa0', r)) < o ? o : i) !== -1 &&
                      !t &&
                      (o < r || !e) &&
                      o <= a.length &&
                      o++)
    ...
    function xc(e, t, n, r, o, i) {
        ...
        let s;
        if (n.nodeType === 3) {
            if ((u = wc(o, i, n, r)) !== -1) return { container: n, offset: u };
            s = n;
        }
        for (
            let c = new bi(n, e.getParent(n, e.isBlock) || t);
            (a = c[o ? 'prev' : 'next']());

        )
            if (a.nodeType !== 3 || $c(a.parentNode)) {
                if (e.isBlock(a) || qc.isEq(a, 'BR')) break;
            } else if ((u = wc(o, i, (s = a))) !== -1)
    ...
    function zc(e, t, n, r, o) {
        ...
        let s;
        for (
            r.nodeType === 3 && r.nodeValue.length === 0 && r[o] && (r = r[o]),
                i = Wc(e, r),
                a = 0;
            a < i.length;
            a++
    ...
    function Ec(t, e, n, r) {
        ...
        if ((e[0].wrapper || (o = i.getParent(n, e[0].block, a)), !o)) {
            const u = i.getParent(n, 'LI,TD,TH');
            o = i.getParent(
        ...
        if (
            (o && e[0].wrapper && (o = Wc(i, o, 'ul,ol').reverse()[0] || o), !o)
        )
            for (
                o = n;
    ...
    function Nc(e, t, n, r, o, i, a) {
        ...
        if (
            ...
            (f = e.getRoot()),
            u.nodeType === 3 && !Kc(u) && (a ? r > 0 : i < u.nodeValue.length))
        )
            return u;
        for (;;) {
    ...
    const Sc = Ge.isContentEditableFalse;
    var kc = Ge.isText;
    const Tc = Ge.isElement;
    var Ac = Ge.isBr;
    var Mc = Va;
    const Rc = function(e) {
        return (
    ...
    var _c = function(e, t, n) {
        ...
        let c = u.offset();
        if (kc(s)) {
            if (vs(e) && c > 0) return _s(s, --c);
            if (ps(e) && c < s.length) return _s(s, ++c);
            r = s;
        } else {
            if (vs(e) && c > 0 && ((o = nc(s, c - 1)), Mc(o)))
    ...
    var qc = {
            ...
            if (
                ...
                for (
                    a < (i = u.childNodes).length
                        ? ((u = i[a]),
                          (r = new bi(u, e.getParent(u, e.isBlock))))
                        : ((u = i[i.length - 1]),
                    ...
                    if (o.nodeType === 3 && !jc(o))
                        return n.setStart(o, 0), void t.setRng(n);
        },
        getNonWhiteSpaceSibling(e, t, n) {
            if (e)
                for (
        ...
        getTextDecoration(t, e) {
            let n;
            return (
                t.getParent(e, function(e) {
                    return (
                        (n = t.getStyle(e, 'text-decoration')) && n !== 'none'
                    );
                }),
                n
            );
    ...
    var $c = Uc;
    var Wc = qc.getParents;
    var Kc = qc.isWhiteSpaceNode;
    var Xc = qc.isTextBlock;
    const Yc = function(e, t, n, r) {
        let o;
        let i = t.startContainer;
        let a = t.startOffset;
        let u = t.endContainer;
        let s = t.endOffset;
        const c = e.dom;
        return (
            i.nodeType === 1 &&
            ...
            u.nodeType === 1 &&
                u.hasChildNodes() &&
                (u = Xa(u, t.collapsed ? s : s - 1)).nodeType === 3 &&
            ...
            ($c(i.parentNode) || $c(i)) &&
                ...
                (i = t.collapsed ? i.previousSibling || i : i.nextSibling || i)
                    .nodeType === 3 && (a = t.collapsed ? i.length : 0)),
            ($c(u.parentNode) || $c(u)) &&
                ((u = $c(u) ? u : u.parentNode),
                (u = t.collapsed ? u.nextSibling || u : u.previousSibling || u)
                    .nodeType === 3 && (s = t.collapsed ? 0 : u.length)),
            t.collapsed &&
            ...
            (n[0].inline || n[0].block_expand) &&
                ((n[0].inline && i.nodeType === 3 && a !== 0) ||
                    (i = Nc(c, n, i, a, u, s, !0)),
                (n[0].inline && u.nodeType === 3 && s !== u.nodeValue.length) ||
                    (u = Nc(c, n, i, a, u, s, !1))),
            n[0].selector &&
                !1 !== n[0].expand &&
                !n[0].inline &&
            ...
            i.nodeType === 1 && ((a = c.nodeIndex(i)), (i = i.parentNode)),
            u.nodeType === 1 && ((s = c.nodeIndex(u) + 1), (u = u.parentNode)),
            {
                startContainer: i,
                startOffset: a,
                endContainer: u,
    ...
    const Jc = function(e, t, o) {
        ...
        const f = t.startOffset;
        let d = t.endContainer;
        const h = t.endOffset;
        if (
            ...
            if (
                (l.nodeType === 1 && l.hasChildNodes() && (l = l.childNodes[f]),
                d.nodeType === 1 &&
                    d.hasChildNodes() &&
                    (d = (function(e, t) {
        ...
        const i =
            void 0 === o
                ? (function(e) {
                      ...
                      return `${e}_${Math.floor(
                          1e9 * Math.random(),
                      )}${++uu}${String(t)}`;
                  })('mce-annotation')
                : o;
        const a = (function h(e, t) {
            const n = {};
            for (var r in e)
    ...
    function nl(o, i, a, u) {
        o.undoManager.transact(function() {
            ...
            if (
                ...
                const t = el(o.getDoc(), u, i, a.decorate);
                Ma(t, '\xa0'),
                    o.selection.getRng().insertNode(t.dom()),
                    o.selection.select(t.dom());
            } else {
                const n = Is.getPersistentBookmark(o.selection, !1);
                const r = o.selection.getRng();
            ...
            getAll(e) {
                const t = (function(e, t) {
                    ...
                    return (
                        z(r, function(e) {
                            const t = ge(e, iu());
                            const n = o.hasOwnProperty(t) ? o[t] : [];
                            o[t] = n.concat([e]);
                        }),
                        o
                    );
    ...
    const sl =
        ((cl.create = function(e, t) {
            const n = new cl(e, ul[e] || 1);
            if (t) for (const r in t) n.attr(r, t[r]);
            return n;
        }),
        ...
        (cl.prototype.attr = function(e, t) {
            let n;
            if (typeof e !== 'string') {
                for (const r in e) this.attr(r, e[r]);
                return this;
            }
        ...
        (cl.prototype.clone = function() {
            let e;
            const t = new cl(this.name, this.type);
        ...
        (cl.prototype.empty = function() {
            if (this.firstChild) {
                for (var e = [], t = this.firstChild; t; t = ol(t, this))
                    e.push(t);
            ...
            if (r)
                do {
                    if (r.type === 1) {
                        ...
                        for (let o = r.attributes.length; o--; ) {
                            const i = r.attributes[o].name;
                            if (
                                i === 'name' ||
                                i.indexOf('data-mce-bookmark') === 0
                            )
                                return !1;
                        }
                    }
                    if (r.type === 8) return !1;
                    if (r.type === 3 && !al.test(r.value)) return !1;
                    if (
                        r.type === 3 &&
                        r.parent &&
                        t[r.parent.name] &&
    ...
    function fl(e, t) {
        ...
        if (n) {
            const r = n[1];
            const o = n[2];
            return typeof r === 'string' && r.toLowerCase() === 'data-mce-bogus'
                ? o
                : null;
        }
        return null;
    ...
    function dl(V, I) {
        ...
        const F = V.comment ? V.comment : e;
        const U = V.cdata ? V.cdata : e;
        const j = V.text ? V.text : e;
        const q = V.start ? V.start : e;
        const $ = V.end ? V.end : e;
        const W = V.pi ? V.pi : e;
        const K = V.doctype ? V.doctype : e;
        return {
            parse(e) {
                function t(e) {
                    let t;
                ...
                for (
                    k = new RegExp(
                        ...
                        S =
                            V.self_closing_elements ||
                            I.getSelfClosingElements(),
                        h = I.getBoolAttrs(),
                        g = V.validate,
                    ...
                    if (
                        (D < r.index && j(B(e.substr(D, r.index - D))),
                        (o = r[6]))
                    )
                        (o = o.toLowerCase()).charAt(0) === ':' &&
                            (o = o.substr(1)),
                            t(o);
                    else if ((o = r[7])) {
                        if (r.index + r[0].length > e.length) {
                            j(B(e.substr(r.index))),
                        ...
                        if (!g || (p = I.getElementRule(o))) {
                            if (
                                ...
                                g &&
                                    ((C = p.attributes),
                                    (w = p.attributePatterns)),
                                (b = r[8])
                                    ? ((l =
                                          b.indexOf('data-mce-type') !== -1) &&
                                          f &&
                                          (v = !1),
                                      ((c = []).map = {}),
                                      b.replace(T, n))
                        ...
                        if ((i = A[o])) {
                            (i.lastIndex = D = r.index + r[0].length),
                                (D = (r = i.exec(e))
                                    ? (v && (u = e.substr(D, r.index - D)),
                                      r.index + r[0].length)
                                    : ((u = e.substr(D)), e.length)),
                                v && (u.length > 0 && j(u, !0), $(o)),
                                (k.lastIndex = D);
                            continue;
                        }
                        m ||
                ...
                for (
                    D < e.length && j(B(e.substr(D))), a = _.length - 1;
                    a >= 0;
                    a--
                )
                    (o = _[a]).valid && $(o.name);
    ...
    function hl(e, t) {
        ...
        let a;
        let u = t;
        const s = /<(\w+) [^>]*data-mce-bogus="all"[^>]*>/g;
        const c = e.schema;
        for (
            u = (function(e, t) {
                const n = new RegExp(
    ...
    function ml(e, t, n) {
        const r = e.getParam(t, n);
        if (r.indexOf('=') === -1) return r;
        const o = e.getParam(t, '', 'hash');
    ...
    function gl(e, t, n) {
        ...
        else if (t.format === 'text') r = fu(n.innerText || n.textContent);
        else {
            if (t.format === 'tree') return e.serializer.serialize(n, t);
            r = (function(e, t) {
                const n = gf(e);
                const r = new RegExp(
                    `^(<${n}[^>]*>(&nbsp;|&#160;|\\s|\xa0|<br \\/>|)<\\/${n}>[\r\n]*|<br \\/>[\r\n]*)$`,
                ...
                start(e, t, n) {
                    ...
                    d.push('</', e, '>'),
                        u &&
                            c[e] &&
                            d.length > 0 &&
                            (t = d[d.length - 1]).length > 0 &&
                            t !== '\n' &&
                            d.push('\n');
                },
                text(e, t) {
                    e.length > 0 && (d[d.length] = t ? e : l(e));
                },
                cdata(e) {
                    d.push('<![CDATA[', e, ']]>');
                },
    ...
    function wl(e, t) {
        const n = Et(t) ? Qc(t).length : Re(t).length + 1;
    ...
    function Ml(e) {
        const t = j.document.createRange();
        try {
            return (
    ...
    function Ol(t, e) {
        const n = t ? t.settings.custom_ui_selector : '';
        return (
    ...
    function Hl(e, t) {
        e.focusedEditor === t.editor && (e.focusedEditor = null),
            e.activeEditor ||
                (nd.unbind(j.document, 'focusin', of), (of = null));
    }
    function Pl(t, e) {
        return (function(e) {
            return e.collapsed
            ...
            (function(r) {
                sd(r) &&
                    Lc.firstPositionIn(r.getBody()).each(function(e) {
                        const t = e.getNode();
                        const n = Ge.isTable(t)
                            ? Lc.firstPositionIn(t).getOr(e)
                            : e;
    ...
    function ql(t, n, r) {
        return (
            ...
            Ul(n) ||
                r.no_events ||
                (t.fire('BeforeSetContent', r), (n = r.content)),
    ...
    function Wl(e) {
        if (!e.removed) {
            const t = e._selectionOverrides;
            const n = e.editorUpload;
            const r = e.getBody();
    ...
    function Xl(a) {
        return function() {
            ...
            for (var n = {}, r = 0; r < e.length; r++) {
                const o = e[r];
                for (const i in o) yd.call(o, i) && (n[i] = a(n[i], o[i]));
            }
            return n;
        };
    }
    function Yl(e) {
        const t = A(e) ? e.join(' ') : e;
        const n = X(K(t) ? t.split(' ') : [], te);
    ...
    function Jl(e, t, n, r) {
        const o = Yl(n.forced_plugins);
        const i = Yl(r.plugins);
        const a = (function(e, t) {
            return Gl(e, t) ? e.sections()[t] : {};
        })(t, 'mobile');
        const u = a.plugins ? Yl(a.plugins) : i;
        ...
        const u = Rn.extend(
            ...
            (function(e, t) {
                ...
                ? (function(e, t, n) {
                      void 0 === n && (n = {});
                      const r = e.sections();
                      const o = r.hasOwnProperty(t) ? r[t] : {};
                ...
                : {},
            {
                ...
                external_plugins: (function(e, t) {
                    const n = t.external_plugins ? t.external_plugins : {};
    ...
    function tf(e, t, n, r) {
        const o = t in e.settings ? e.settings[t] : n;
        return r === 'hash'
            ? (function(e) {
                  let n = {};
                  return (
    ...
    let of;
    var af = dl;
    var uf = { trimExternal: hl, trimInternal: hl };
    const sf = function(e) {
    ...
    var gf = function(e) {
        ...
        const t = e.getParam('forced_root_block', 'p');
        return !1 === t ? '' : !0 === t ? 'p' : t;
    };
    const pf = function(e) {
    ...
    const Vf = function(e) {
        const t = e.settings.content_css;
        return K(t)
            ? X(t.split(','), te)
            : A(t)
            ? t
    ...
    const qf = function(a) {
        ...
        if (a.length === 0) throw new Error('there must be at least one case');
        const u = [];
        const n = {};
        return (
            z(a, function(e, r) {
                        ...
                        return {
                            ...
                            match(e) {
                                ...
                                if (
                                    ...
                                    throw new Error(
                                        `Not all branches were specified when using match. Specified: ${t.join(
                                            ', ',
                                        )}\nRequired: ${u.join(', ')}`,
                                    );
    ...
    const $f = { create: be('start', 'soffset', 'finish', 'foffset') };
    const Wf = qf([
        { before: ['element'] },
        { on: ['element', 'offset'] },
        { after: ['element'] },
    ...
    var Gf = oe().browser;
    var Jf = function(e) {
        const t = Nl(e) ? Tl(bt.fromDom(e.getBody())) : k.none();
                ...
                : (function(t) {
                      ...
                      const o = (function(t, e) {
                          return t.dom.getParent(e, function(e) {
                              return t.dom.getContentEditable(e) === 'true';
                          });
                      })(t, e.getNode());
    ...
    const gd = function(e, t, n, r) {
        e.fire('ObjectResizeStart', { target: t, width: n, height: r });
    };
    const pd = function(e, t, n, r) {
        e.fire('ObjectResized', { target: t, width: n, height: r });
    };
    var vd = Yi.DOM;
    var yd = Object.prototype.hasOwnProperty;
    var bd = Xl(function(e, t) {
        return T(e) && T(t) ? bd(e, t) : t;
    });
    const Cd = Xl(function(e, t) {
        return t;
    });
    var wd = be('sections', 'settings');
    const xd = oe().deviceType;
    var zd = xd.isTouch();
    var Ed = xd.isPhone();
    var Nd = xd.isTablet();
    var Sd = ['lists', 'autolink', 'autosave'];
    var kd = { table_grid: !1, object_resizing: !1, resize: !1 };
    const Td = d(nf, 'clientWidth');
    const Ad = d(nf, 'clientHeight');
    const Md = d(rf, 'margin-top');
    const Rd = d(rf, 'margin-left');
    const Dd = function(e, t, n) {
        const r = bt.fromDom(e.getBody());
        const o = e.inline
            ? r
            : (function(e) {
    ...
    function Od(n) {
        ...
        return (
            (a = n).on('SkinLoaded', function() {
                const e = a.settings.service_message;
    ...
    const jd = function(e) {
        for (let t = [], n = 1; n < arguments.length; n++)
            t[n - 1] = arguments[n];
        const r = j.window.console;
        r &&
            (r.error ? r.error.apply(r, arguments) : r.log.apply(r, arguments));
    };
    const qd = {
        pluginLoadError(e, t) {
            Ld(Vd('plugin', e, t));
        ...
        languageLoadError(e, t) {
            Ld(Vd('language', e, t));
        },
        pluginInitError(e, t, n) {
            const r = oa.translate(['Failed to initialize plugin: {0}', t]);
            jd(r, n), Pd(e, r);
        },
        uploadError(e, t) {
    ...
    const Wd = pa.PluginManager;
    const Kd = pa.ThemeManager;
    const Xd = function(e) {
        return e.indexOf('blob:') === 0
            ? (function(i) {
                  return new en(function(e, t) {
                      function n() {
                          t(
                              `Cannot convert ${i} to Blob. Resource might not exist or is inaccessible.`,
                          );
                      }
                      try {
                          const r = new j.XMLHttpRequest();
                          r.open('GET', i, !0),
                              (r.responseType = 'blob'),
                              (r.onload = function() {
                                  this.status === 200 ? e(this.response) : n();
                              }),
                              (r.onerror = n),
                              r.send();
                      } catch (o) {
                    ...
                    (t = y(
                        ...
                        function(e) {
                            ...
                            return (
                                ...
                                (t.indexOf('blob:') === 0
                                    ? !o.isUploaded(t) && n(e)
                                    : t.indexOf('data:') === 0 && n(e))
                            );
                        },
                    ));
                const r = X(t, function(n) {
                    if (a[n.src])
                    ...
                    const e = new en(function(e, t) {
                        !(function(n, r, o, t) {
                            let i;
                            let a;
                            r.src.indexOf('blob:') !== 0
                                ? ((i = Gd(r.src).data),
    ...
    function eh(o) {
        ...
        function s(n) {
            return (
                ...
                p().then(
                    t(function(r) {
                        const e = X(r, function(e) {
                            return e.blobInfo;
                        });
                        return f.upload(e, a).then(
                            t(function(e) {
                                const t = X(e, function(e, t) {
                                    const n = r[t].image;
                                    return (
                                        e.status && Tf(o)
                                            ? u(n, e.url)
                                            : e.error &&
                                              qd.uploadError(o, e.error),
        ...
        function c(t) {
            return (
                ...
                (t.getAttribute('src').indexOf('data:') !== 0 || Nf(o)(t))
            );
        }
        function l(e) {
            return e.replace(/src="(blob:[^"]+)"/g, function(e, n) {
                const t = m.getResultUri(n);
                if (t) return `src="${t}"`;
                let r = h.getByUri(n);
                return (r =
                    r ||
            ...
            return {
                ...
                removeByUri(t) {
                    n = y(n, function(e) {
                        return (
                            e.blobUri() !== t ||
                            (j.URL.revokeObjectURL(e.blobUri()), !1)
                        );
                    });
                },
                destroy() {
        ...
        var m = (function v() {
            ...
            return {
                ...
                isPending(e) {
                    return !!t(e) && r[e].status === 1;
                },
                isUploaded(e) {
                    return !!t(e) && r[e].status === 2;
                },
                markPending(e) {
                    r[e] = n(1, null);
                },
    ...
    function ah(o, e) {
        return Ga(
            ...
            function(e, t) {
                const n = g(gh(o), d(ze, e));
                const r = g(ph(o), d(ze, t));
    ...
    function uh(e, t, n, r) {
        ...
        do {
            if (n.nodeType === 3 && Rn.trim(n.nodeValue).length !== 0)
                return void (r
                    ? t.setStart(n, 0)
    ...
    const vh =
        ...
        (yh.prototype.isSameElementPath = function(e) {
            ...
            if (
                ...
                if (t === -1) return (this.lastPath = n), !0;
            }
    ...
    function yh(r) {
        ...
        'onselectionchange' in r.getDoc() ||
            ...
            r.on('SelectionChange', function() {
                const e = r.selection.getStart(!0);
                !e ||
            ...
            r.on('mouseup', function(e) {
                !e.isDefaultPrevented() &&
                    sh(r) &&
                    (r.selection.getNode().nodeName === 'IMG'
    ...
    function xh(e) {
        const t = e.container();
        return Ge.isText(t) && t.data.length === 0;
    }
    function zh(t, n) {
        return function(e) {
            return k
    ...
    function Eh(e) {
        return e.nodeName === 'IMG' && ve(bt.fromDom(e), 'display') === 'block';
    }
    function Nh(e) {
    ...
    const Oh = zh(!0, Eh);
    const Bh = zh(!1, Eh);
    const Hh = zh(!0, Ge.isTable);
    const Ph = zh(!1, Ge.isTable);
    const Lh = zh(!0, Nh);
    const Vh = zh(!1, Nh);
    ...
    function Ih(o, i, a, e, u, t) {
        function n(e) {
            ...
            let r;
            for (
                r = Sh([e]), o === -1 && (r = r.reverse()), t = 0;
                t < r.length;
                t++
            )
                if (((n = r[t]), !a(n, s))) {
                    if (
                        (l.length > 0 && i(n, Tn.last(l)) && c++,
                        (n.line = c),
                        u(n))
                    )
                        return !0;
    ...
    function Jh(i, a) {
        return function(e) {
            if (
                ...
                const t = g(a.dom.getParents(e.target), Au(eg, tg)).getOr(null);
                if (
                    (function(e, t) {
                        return eg(t) && t !== e;
                    })(a.getBody(), t)
                ) {
                    const n = a.dom.getPos(t);
                    const r = a.getBody();
                    const o = a.getDoc().documentElement;
                    (i.element = t),
                        (i.screenX = e.screenX),
                        (i.screenY = e.screenY),
                        (i.maxX =
                            (a.inline ? r.scrollWidth : o.offsetWidth) - 2),
                        (i.maxY =
                            (a.inline ? r.scrollHeight : o.offsetHeight) - 2),
                        (i.relX = e.pageX - n.x),
                        (i.relY = e.pageY - n.y),
    ...
    function Zh(e) {
        ...
        (t = Yi.DOM),
            ...
            (n = Jh(u, e)),
            (r = (function(r, o) {
                const i = vn.throttle(function(e, t) {
                    o._selectionOverrides.hideFakeCaret(),
                ...
                return function(e) {
                    ...
                    if (
                        ...
                        if (
                            o
                                .fire('dragstart', { target: r.element })
                                .isDefaultPrevented()
                        )
                            return;
    ...
    function nm(e, t, n) {
        const r = Ns(1, e.getBody(), t);
        const o = _s.fromRangeStart(r);
        const i = o.getNode();
        if (ig(i)) return em(1, e, i, !o.isAtEnd(), !1);
        const a = o.getNode(!0);
        if (ig(a)) return em(1, e, a, !1, !1);
        const u = e.dom.getParent(o.getNode(), function(e) {
            return ig(e) || og(e);
        });
    ...
    function im(g) {
        ...
        function p(e, t, n, r) {
            return (
                ...
                g
                    ...
                    .isDefaultPrevented()
                    ? null
                    : (r && g.selection.scrollIntoView(t, e === -1),
                      u.show(n, t))
            );
        }
        function t(e) {
        ...
        const b = `sel-${g.dom.uniqueId()}`;
        const C = function(e) {
            return t(e.startContainer) || t(e.endContainer);
        };
        const s = function(e) {
            const t = g.schema.getShortEndedElements();
            const n = g.dom.createRng();
            const r = e.startContainer;
            const o = e.startOffset;
        ...
        const c = function(e, t) {
            ...
            (r = xa(bt.fromDom(g.getBody()), `#${b}`).fold(
                ...
                o.addRange(e);
            const m = bt.fromDom(n);
            return (
                z(ga(bt.fromDom(g.getBody()), '*[data-mce-selected]'), function(
                    e,
                ) {
        ...
        return (
            Sn.ceFalse &&
                (function() {
                    g.on('mouseup', function(e) {
                        ...
                        g.on('click', function(e) {
                            ...
                            (t = om(g, e.target)) &&
                                ...
                                ug(t) &&
                                    g.dom.isChildOf(t, g.selection.getNode()) &&
                                    l());
                        }),
                    ...
                    function i(e, t) {
                        const n = g.dom.getParent(e, g.dom.isBlock);
                        const r = g.dom.getParent(t, g.dom.isBlock);
                        return (
                            !(
                                !n ||
                                !g.dom.isChildOf(n, r) ||
                            ...
                            (n &&
                                ...
                                (function(e) {
                                    ...
                                    const n = _s.before(e.firstChild);
                                    const r = t.next(n);
                                    return r && !Lh(r) && !Vh(r);
                                })(n))
                        );
                        ...
                        g.on('mousedown', function(e) {
                            ...
                            if (
                                ...
                                if ((t = om(g, n)))
                                    ...
                                    l(), w();
                                    const r = Xh(y, e.clientX, e.clientY);
                                    if (r && !i(e.target, r.node)) {
                                        e.preventDefault();
                                        const o = p(1, r.node, r.before, !1);
                                        g.getBody().focus(), a(o);
                                    }
                                }
                        }),
    ...
    function lm(e) {
        return e.type === 'fragmented' ? e.fragments.join('') : e.content;
    }
    function fm(e) {
        const t = bt.fromTag(
            'body',
            gg.get().getOrThunk(function() {
                const e = j.document.implementation.createHTMLDocument('undo');
        ...
        var a = {
            ...
            add(e, t) {
                return (function(e, t, n, r, o, i, a) {
                    ...
                    if (
                        ...
                        for (let l = 0; l < t.data.length - 1; l++)
                            t.data[l] = t.data[l + 1];
                        t.data.length--, n.set(t.data.length);
                    }
                    (i.bookmark = Is.getUndoBookmark(e.selection)),
                        n.get() < t.data.length - 1 &&
                            (t.data.length = n.get() + 1),
                        t.data.push(i),
                        n.set(t.data.length - 1);
                    const f = { level: i, lastLevel: c, originalEvent: a };
                    return (
                        e.fire('AddUndo', f),
                        n.get() > 0 && (e.setDirty(!0), e.fire('change', f)),
                        i
                    );
                })(n, a, i, o, r, e, t);
            },
            ...
            hasUndo() {
                return (function(e, t, n) {
                    return (
                        n.get() > 0 ||
                        (t.typing && t.data[0] && !yg(pg(e), t.data[0]))
                    );
                })(n, a, i);
            },
            hasRedo() {
            ...
            extra(e, t) {
                !(function(e, t, n, r, o) {
                    if (t.transact(r)) {
                        const i = t.data[n.get()].bookmark;
                        const a = t.data[n.get() - 1];
                        vg(e, a, !0),
                            t.transact(o) &&
                                (t.data[n.get() - 1].beforeBookmark = i);
                    }
                })(n, a, i, e, t);
            },
        };
    ...
    function vm(t, e, n, r) {
        const o = t.dom.getRoot();
        return (
            e !== o &&
            ((e = t.dom.getParent(e, function(e) {
                return (
                    !!pm(t, e, n) || e.parentNode === o || !!zg(t, e, n, r, !0)
                );
            })),
            zg(t, e, n, r))
        );
    ...
    function ym(e, t, n) {
        return (
            !!xg(t, n.inline) ||
            !!xg(t, n.block) ||
            (n.selector ? t.nodeType === 1 && e.is(t, n.selector) : void 0)
        );
    }
                ...
                for (a in c)
                    if (c.hasOwnProperty(a)) {
                        ...
                        if (
                            ...
                            !xg(
                                u,
                                qc.normalizeStyleValue(
                                    e,
                                    qc.replaceVars(c[a], i),
                                    a,
                                ),
                            )
                        )
    ...
    function xm(e, t, n) {
        if (n !== 0) {
            const r = e.data.slice(t, t + n);
            const o = t + n >= e.data.length;
            const i = t === 0;
            e.replaceData(
                t,
                n,
    ...
    function Om(e) {
        if (Tg(e)) {
            const t = bt.fromHtml('<br data-mce-bogus="1">');
            return Ni(e), _i(e, t), k.some(_s.before(t.dom()));
        }
        return k.none();
    }
    function Bm(e, t, a) {
        const n = ke(e).filter(Et);
        const r = Te(e).filter(Et);
        return (
            Oi(e),
            (function(e, t, n, r) {
    ...
    function Vm(e, t, n) {
        ...
        if (Hm(t)) Ag(e, !1, bt.fromDom(t), n);
            ...
            const i = o.getRng();
            const a = r.getParent(t, r.isBlock);
            const u = (function(e) {
                const t = Pm(e);
                return (
                    t && t.nodeValue.charAt(0) === Mg && t.deleteData(0, 1), t
                );
            })(t);
            i.startContainer === u &&
                i.startOffset > 0 &&
    ...
    function Fm(e, t, n) {
        const r = e.dom;
        const o = r.getParent(n, d(qc.isTextBlock, e));
        o && r.isEmpty(o)
        ...
        t.on('mouseup keydown', function(e) {
            !(function(e, t) {
                ...
                Im(e, null, !1),
                    ...
                    (t !== 37 && t !== 39) || Im(e, is(r, n.getStart()));
            })(t, e.keyCode);
        });
    }
    function $m(e, t) {
    ...
    let Wm;
    let Km;
    const Xm = d(Ih, Th.Up, qa, $a);
    const Ym = d(Ih, Th.Down, $a, qa);
    var Gm = Ge.isContentEditableFalse;
    var Jm = bs;
    var Qm = function(t, n, e) {
        ...
        if (
            ...
            const r = e.startContainer.childNodes[e.startOffset];
            if (Ge.isElement(r))
    ...
    var Zm = function(e, t) {
        return (function(e, t, n) {
            ...
            (function(e, t) {
                ...
                const n = Yh(e.getContentAreaContainer());
                const r = (function(e) {
                    const t = e.getBody();
                    const n = e.getDoc().documentElement;
                    const r = { left: t.scrollLeft, top: t.scrollTop };
                    const o = {
    ...
    var eg = Ge.isContentEditableFalse;
    var tg = Ge.isContentEditableTrue;
    var ng = function(e) {
    ...
    var og = Ge.isContentEditableTrue;
    var ig = Ge.isContentEditableFalse;
    var ag = function(t) {
        const e = ua(function() {
            if (
                !t.removed &&
                ...
                const e = rm(t, t.selection.getRng(), !1);
                t.selection.setRng(e);
            }
        }, 0);
        t.on('focus', function() {
    ...
    var ug = Ge.isContentEditableTrue;
    var sg = Ge.isContentEditableFalse;
    const cg = 0;
    const lg = 2;
    const fg = 1;
    const dg = function(m, g) {
        function p(e, t, n, r) {
        ...
        var c = function(e, t, n, r, o) {
            ...
            if (
                ...
                for (let s = i.start; s < i.end; ++s) o.push([0, m[s]]);
    ...
    var pg = function(n) {
        ...
        return (
            ...
            (function(e) {
                ...
                (t = (r = v(e, function(e) {
                    const t = uf.trimInternal(n.serializer, e);
                    return t.length > 0 ? [t] : [];
                })).join('')),
            )
                ? sm(r)
    ...
    var Ng = Ge.hasAttribute('data-mce-bookmark');
    const Sg = Ge.hasAttribute('data-mce-bogus');
    const kg = Ge.hasAttributeValue('data-mce-bogus', 'all');
    var Tg = function(e) {
        return (function(e) {
            let t;
            let n = 0;
    ...
    var Ag = function(t, n, e, r) {
        void 0 === r && (r = !0);
        const o = Rm(n, t.getBody(), e.dom());
        const i = ba(
            e,
            d(_m, t),
            (function(t) {
            ...
            r.collapsed ||
                ...
                Og(
                    _g(_g(n, t), function(e) {
                        return (
                            t(e.previousSibling) &&
                            Tn.indexOf(n, e.previousSibling) !== -1
                        );
                    }),
                    function(e) {
                        !(function(e, t) {
    ...
    function Pg(e, t, n) {
        ...
        return (
            ...
            Ge.isText(r) &&
                !n &&
                o === 0 &&
                (r = new bi(r, e.getBody()).prev() || r),
            r
        );
    }
    function Lg(e, t, n, r) {
        const o = e.create(n, r);
        return t.parentNode.insertBefore(o, t), o.appendChild(t), o;
    }
    function Vg(e, t, n, r, o) {
        const i = bt.fromDom(t);
        const a = bt.fromDom(e.create(r, o));
        const u = n ? Me(i) : Ae(i);
        return (
            Ei(a, u), n ? (wi(i, a), zi(a, i)) : (xi(i, a), _i(a, i)), a.dom()
        );
    }
    function Ig(e, t, n, r) {
        return (
        ...
        if (
            !(function(e, t, n) {
                return (
                    ...
                    !!ep(t, n.block) ||
                    (n.selector
                        ? Ge.isElement(t) && e.is(t, n.selector)
                        : void 0)
                );
            })(s, i, r) &&
            !(function(e, t) {
            ...
            for (
                Zg(r.styles, function(e, t) {
                    (e = qc.normalizeStyleValue(s, qc.replaceVars(e, o), t)),
                        typeof t === 'number' && ((t = e), (a = 0)),
                        (!r.remove_similar &&
                            a &&
                            !ep(qc.getStyle(s, a, t), e)) ||
                            s.setStyle(i, t, ''),
                        (u = 1);
                }),
                    u &&
                    ...
                    Zg(r.attributes, function(e, t) {
                        ...
                        if (
                            ...
                            t === 'class' && i.removeAttribute('className'),
                                Qg.test(t) &&
                                    i.removeAttribute(`data-mce-${t}`),
                                i.removeAttribute(t);
                        }
                    }),
                ...
                const c = n[t].nodeName;
                if (c.indexOf('_') !== 0 && c.indexOf('data-') !== 0) return !1;
            }
        return r.remove !== 'none'
            ? ((function(t, e, n) {
                  let r;
                  const o = e.parentNode;
                  const i = t.dom;
                  ...
                  n.block &&
                      ...
                      (n.selector && n.inline && !ep(n.inline, e)) ||
                          i.remove(e, 1);
              })(e, i, r),
              !0)
            : void 0;
    ...
    function Ug(e) {
        return e && e.nodeType === 1 && !Uc(e) && !os(e) && !Ge.isBogus(e);
    }
    function jg(e, t) {
        let n;
        for (n = e; n; n = n[t]) {
            if (n.nodeType === 3 && n.nodeValue.length !== 0) return e;
            if (n.nodeType === 1 && !Uc(n)) return n;
        }
        return e;
    }
    function qg(e, t, n) {
                    ...
                    return (function(e, t, n) {
                        ...
                        z(t.split(','), function(e) {
                            (r[e].callbacks = y(r[e].callbacks, function(e) {
                                ...
                                r[e].callbacks.length === 0 && delete r[e];
                        }),
                            e.set(r);
                    })(t, n, r);
                },
    ...
    var Jg = Rn.each;
    var Qg = /^(src|href|style)$/;
    var Zg = Rn.each;
    var ep = qc.isEq;
    const tp = Fg;
    const np = function(a, n, u, e, r) {
        function i(e) {
            const t = (function(n, e, r, o, i) {
                let a;
                return (
                    Zg(qc.getParents(n.dom, e.parentNode).reverse(), function(
                        e,
                    ) {
                        let t;
                        a ||
        ...
        function t(e) {
            let t;
            let n;
            const r = e.commonAncestorContainer;
            ...
            Jc(h, e, function(e) {
                Zg(e, function(e) {
                    g(e),
                        Ge.isElement(e) &&
                            a.dom.getStyle(e, 'text-decoration') ===
                                'underline' &&
                            e.parentNode &&
                            qc.getTextDecoration(h, e.parentNode) ===
                                'underline' &&
                            Fg(
                                a,
                                {
        ...
        if (e)
            e.nodeType
                ? ((c = h.createRng()).setStartBefore(e),
                  c.setEndAfter(e),
                  t(c))
                : t(e);
        else if (h.getContentEditable(m.getNode()) !== 'false')
            m.isCollapsed() &&
            f.inline &&
                ...
                ? (function(e, t, n, r) {
                      ...
                      if (c)
                          if (u) {
                              ...
                              let g = Yc(e, m, e.formatter.get(t), !0);
                              (g = wm(g)),
        ...
        t.styles &&
            ...
            op(
                ...
                Wg(
                    e,
                    'backgroundColor',
                    qc.replaceVars(t.styles.backgroundColor, n),
                ),
            );
    };
    const cp = function(e, t, n, r) {
        (t.inline !== 'sub' && t.inline !== 'sup') ||
            (op(r, $g(e, 'fontSize'), Wg(e, 'fontSize', '')),
            e.remove(e.select(t.inline === 'sup' ? 'sub' : 'sup', r), !0));
    };
    const lp = function(e, t, n, r) {
        r &&
            !1 !== t.merge_siblings &&
            ((r = qg(e, qc.getNonWhiteSpaceSibling(r), r)),
            (r = qg(e, r, qc.getNonWhiteSpaceSibling(r, !0))));
    };
    const fp = function(t, n, r, o, i) {
    ...
    var mp = function(m, g, p, r) {
                    ...
                    var u = function(e) {
                        ...
                        if (C.wrapper && Eg.matchNode(m, e, g, p)) a = 0;
                            ...
                            (!c &&
                                ...
                                e.nodeValue.charCodeAt(0) === 65279) ||
                            os(e) ||
        ...
        let t;
        let n;
        var b = m.formatter.get(g);
        var C = b[0];
        var o = !r && m.selection.isCollapsed();
        var i = m.dom;
        const a = m.selection;
        if (i.getContentEditable(a.getNode()) !== 'false') {
            if (C) {
                if (r)
                    r.nodeType
                        ? y(b, r) ||
    ...
    const gp = { applyFormat: mp };
    var pp = function(r, e, t, n) {
        const o = Nt(t.get());
        const i = {};
        const a = {};
        const u = y(qc.getParents(r.dom, e), function(e) {
        ...
        const s = vp(t.get(), a, e, u);
        t.set({ ...i, ...s });
    };
    var vp = function(e, n, r, o) {
    ...
    function bp(e, t) {
        ...
        let r;
        let o;
        const c = (t && t.schema) || vr({});
        var l = function(n, e, t) {
            let r;
            let o;
            let i;
            const a = e.length > 0 && e[0];
            const u = a && a.name;
            if (
                (i = (function(e, t) {
                    const n =
                        typeof e !== 'string' ? e.nodeName.toLowerCase() : e;
                    const r = c.getElementRule(n);
                    const o = r && r.parentsRequired;
                    return (
                        !(!o || !o.length) &&
                        (t && Rn.inArray(o, t) !== -1 ? t : o[0])
                    );
                })(n, u))
            )
    ...
    function xp(e, i, a) {
        e.addNodeFilter('font', function(e) {
            z(e, function(e) {
                const t = i.parse(e.attr('style'));
                const n = e.attr('color');
                const r = e.attr('face');
                const o = e.attr('size');
                n && (t.color = n),
                    r && (t['font-family'] = r),
    ...
    function zp(e, t) {
        ...
        t.convert_fonts_to_spans &&
            xp(e, n, Rn.explode(t.font_size_legacy_values)),
            (function(e, n) {
            ...
            parse(e, a) {
                ...
                const y =
                    'forced_root_block' in a
                        ? a.forced_root_block
                        : T.forced_root_block;
                const b = !1 === (m = y) ? '' : !0 === m ? 'p' : m;
                const C = A.getWhiteSpaceElements();
                const w = /^[ \t\r\n]+/;
                const x = /[ \t\r\n]+$/;
                const z = /[ \t\r\n]+/g;
                const E = /^[ \t\r\n]+$/;
                f =
                    C.hasOwnProperty(a.context) ||
                    C.hasOwnProperty(T.root_name);
                function N(e) {
                    let t;
                    let n;
                    let r;
                    let o;
                    const i = A.getBlockElements();
                    for (t = e.prev; t && t.type === 3; ) {
                        if ((r = t.value.replace(x, '')).length > 0)
                            return void (t.value = r);
                        if ((n = t.next)) {
                            if (n.type === 3 && n.value.length) {
                                t = t.prev;
                                continue;
                            }
                            if (
                ...
                const k = (d = new sl(a.context || T.root_name, 11));
                if (
                    (t.parse(e),
                    v &&
                        h.length &&
            ...
            (function(e, g) {
                ...
                g.remove_trailing_brs &&
                    e.addNodeFilter('br', function(e, t, n) {
                        ...
                        let l;
                        const f = e.length;
                        const d = Rn.extend({}, p.getBlockElements());
                        const h = p.getNonEmptyElements();
                        const m = p.getNonEmptyElements();
                    ...
                    g.fix_list_elements &&
                        e.addNodeFilter('ul,ol', function(e) {
                            for (var t, n, r = e.length; r--; )
                                if (
                                    (n = (t = e[r]).parent).name === 'ul' ||
                                    n.name === 'ol'
                                )
                                    if (t.prev && t.prev.name === 'li')
                                        t.prev.append(t);
                                    else {
                                        const o = new sl('li', 1);
                                        o.attr(
    ...
    function kp(e, t, n) {
        Rn.inArray(t, n) === -1 &&
            (e.addAttributeFilter(n, function(e, t) {
                for (let n = e.length; n--; ) e[n].attr(t, null);
            }),
            t.push(n));
    }
    ...
    function Ap(a, u) {
        ...
        return (
            ...
            Pp(l, a, s),
            {
                ...
                serialize(e, t) {
                    const n = Cd({ format: 'html' }, t || {});
                    const r = Vp(u, e, n);
                    const o = (function(e, t, n) {
                        const r = fu(
                            n.getInner ? t.innerHTML : e.getOuterHTML(t),
                        );
                        return n.selection || Kn(bt.fromDom(t))
                            ? r
                            : Rn.trim(r);
                    })(s, r, n);
                    const i = (function(e, t, n) {
                        const r = n.selection
                            ? Cd({ forced_root_block: !1 }, n)
                            : n;
                        const o = e.parse(t, r);
                        return Lp(o), o;
                    })(l, o, n);
                    return n.format === 'tree' ? i : Tp(u, a, c, i, n);
                },
                addRules(e) {
        ...
        return 'preview' in e && !1 === (u = e.preview)
            ...
            : ((t = e.block || e.inline || 'span'),
              ...
              Rp(u.split(' '), function(e) {
                  let t = Dp.getStyle(o, e, !0);
                  if (
                      !(
                          (e === 'background-color' &&
                              /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
                              ((t = Dp.getStyle(n.getBody(), e, !0)),
                              Dp.toHex(t).toLowerCase() === '#ffffff')) ||
                          (e === 'color' &&
                              Dp.toHex(t).toLowerCase() === '#000000')
                      )
                  ) {
                      if (e === 'font-size' && /em|%$/.test(t)) {
                          if (a === 0) return;
                          t = `${(parseFloat(t) / (/%$/.test(t) ? 100 : 1)) *
                              a}px`;
                      }
                      e === 'border' && t && (s += 'padding:0 2px;'),
                          (s += `${e}:${t};`);
                  }
              }),
        ...
        t.addAttributeFilter('data-mce-tabindex', function(e, t) {
            ...
            t.addAttributeFilter('src,href,style', function(e, t) {
                for (
                    ...
                    (r = (n = e[o]).attr(i)) !== undefined
                        ? (n.attr(t, r.length > 0 ? r : null), n.attr(i, null))
                        : ((r = n.attr(t)),
                          t === 'style'
                              ? (r = c.serializeStyle(c.parseStyle(r), n.name))
                              : a && (r = a.call(u, r, t, n.name)),
                          n.attr(t, r.length > 0 ? r : null));
            }),
            ...
            t.addAttributeFilter('data-mce-type', function(e, t, n) {
                for (var r, o = e.length; o--; ) {
                    if (
                        (r = e[o]).attr('data-mce-type') === 'bookmark' &&
                        !n.cleanup
                    )
            ...
            t.addNodeFilter('#comment', function(e) {
                for (var t, n = e.length; n--; )
                    (t = e[n]).value.indexOf('[CDATA[') === 0
                        ? ((t.name = '#cdata'),
                          (t.type = 4),
                          (t.value = t.value.replace(/^\[CDATA\[|\]\]$/g, '')))
                        : t.value.indexOf('mce:protected ') === 0 &&
                          ((t.name = '#text'),
                          (t.type = 3),
                          (t.raw = !0),
            ...
            t.addAttributeFilter('data-mce-type', function(e) {
                z(e, function(e) {
                    e.attr('data-mce-type') === 'format-caret' &&
            ...
            ? (function(e, t, n) {
                  ...
                  return (
                      ...
                      (r = j.document.implementation).createHTMLDocument &&
                          ...
                          Rn.each(
                              t.nodeName === 'BODY' ? t.childNodes : [t],
                              function(e) {
    ...
    function Kp(r, a) {
        ...
        const A = a.getBody();
        function M(e) {
            return e && (e.nodeName === 'IMG' || a.dom.is(e, 'figure.image'));
        }
        function e(e) {
            const t = e.target;
            !(function(e, t) {
                if (e.type !== 'longpress' && e.type.indexOf('touch') !== 0)
        ...
        function D(e) {
            let t = a.settings.object_resizing;
            return (
                !1 !== t &&
                !Sn.iOS &&
                (typeof t !== 'string' && (t = 'table,img,figure.image,div'),
                e.getAttribute('data-mce-resize') !== 'false' &&
                    e !== a.getBody() &&
                    we(bt.fromDom(e), t))
            );
        }
        function _(e) {
            ...
            (t = e.screenX - d),
                ...
                (r = (r = f.startPos.x + t) > 0 ? r : 0),
                (o = (o = f.startPos.y + n) > 0 ? o : 0),
                z.setStyles(c, { left: r, top: o, display: 'block' }),
                (c.innerHTML = `${b} &times; ${C}`),
                f[2] < 0 &&
                    s.clientWidth <= b &&
                    z.setStyle(s, 'left', m + (p - b)),
                f[3] < 0 &&
                    s.clientHeight <= C &&
                    z.setStyle(s, 'top', g + (v - C)),
        ...
        var O = function() {
            ...
            e('width', b),
                ...
                S !== N &&
                    (z.unbind(S, 'mousemove', _), z.unbind(S, 'mouseup', O)),
                z.remove(s),
                z.remove(c),
                B(u),
                pd(a, u, b, C),
        ...
        var H = function() {
            ...
            for (e in (P(), u && u.removeAttribute('data-mce-selected'), l))
                (t = z.get(`mceResizeHandle${e}`)) &&
                    (z.unbind(t), z.remove(t));
        };
        var P = function() {
            for (const e in l) {
                const t = l[e];
                    ...
                    (Sn.browser.isIE() || Sn.browser.isEdge()) &&
                        (a.on('mousedown click', function(e) {
                            ...
                            i ||
                                ...
                                o(t) ||
                                (e.button !== 2 &&
                                    a.selection.select(t, n === 'TABLE'),
                                e.type === 'mousedown' && a.nodeChanged());
                        }),
                        a.dom.bind(A, 'mscontrolselect', function(e) {
                            ...
                            /^(TABLE|IMG|HR)$/.test(e.target.nodeName) &&
                                (e.preventDefault(),
                                e.target.tagName === 'IMG' && t(e.target));
                        }));
                const t = vn.throttle(function(e) {
                    a.composing || n(e);
                });
                a.on(
    ...
    const Xp = Wp;
    var Yp = Ge.isContentEditableFalse;
    var Gp = Ge.isContentEditableTrue;
    function Jp(e) {
        const t = bt.fromDom(j.document);
        const n = Ti(t);
        const r = (function(e, t) {
            const n = t.owner(e);
            return Iv(t, n);
    ...
    function Zp(e, t) {
        const n = (function(e) {
            ...
            const i = ki(r.pageYOffset, o.scrollTop);
            const a = ki(r.pageXOffset, o.scrollLeft);
            const u = ki(o.clientTop, n.clientTop);
            const s = ki(o.clientLeft, n.clientLeft);
    ...
    function ev(e, t) {
        const n = (function(e, t) {
            const n = Re(e);
            if (n.length === 0 || Qp(e)) return { element: e, offset: t };
        ...
        const r = bt.fromHtml(`<span data-mce-bogus="all">${lu}</span>`);
        return (
            wi(n.element, r),
            Zp(r, function() {
                return Oi(r);
    ...
    function ov(e, t, n, r) {
        ...
        if (n) Ai(o.left(), o.top(), r);
            ...
            const i = o.top() - t + (e.bottom - o.top());
            Ai(o.left(), i, r);
        }
    }
    ...
    function uv(e, t, n, r, o) {
        const i = t.dom().defaultView.innerHeight;
        iv(t, n, i, r, o);
        const a = Jp(r.element);
        const u = Vi(j.window);
        a.top() < u.y()
            ? Mi(r.element, !1 !== o)
    ...
    function hv(e, t) {
        const n = (t || j.document).createDocumentFragment();
        return (
            z(e, function(e) {
                n.appendChild(e.dom());
            }),
    ...
    function pv(e, t) {
        for (let n = e.rows(), r = 0; r < n.length; r++)
            for (let o = n[r].cells(), i = 0; i < o.length; i++)
    ...
    function vv(e, t, n, r, o) {
        for (var i = [], a = e.rows(), u = n; u <= o; u++) {
            const s = a[u].cells();
            const c = t < r ? s.slice(t, r + 1) : s.slice(r, t + 1);
    ...
    function xv(t, n) {
        return g(t, function(e) {
            return ie(e) === 'li' && ah(e, n);
        }).fold($([]), function(e) {
            return (function(e) {
                return g(e, function(e) {
                    return ie(e) === 'ul' || ie(e) === 'ol';
                });
            })(t)
                .map(function(e) {
    ...
    function zv(e, t) {
        const n = bt.fromDom(t.commonAncestorContainer);
        const r = dh(n, e);
        const o = y(r, function(e) {
            return _n(e) || Vn(e);
        });
        const i = xv(r, t);
        const a = o.concat(
    ...
    function _v(e) {
        return e.dom().length === 0 ? (Oi(e), k.none()) : k.some(e);
    }
    function Ov(e, t, n, r, o) {
        const i = n ? t.startContainer : t.endContainer;
        const a = n ? t.startOffset : t.endOffset;
        return k
            .from(i)
            .map(bt.fromDom)
            .map(function(e) {
    ...
    function Pv(e, t) {
        for (var n = e; e && Ge.isText(e) && e.length === 0; )
            e = t ? e.nextSibling : e.previousSibling;
        return e || n;
    }
    function Lv(e, t, n) {
        if (e && e.hasOwnProperty(t)) {
            const r = y(e[t], function(e) {
                return e !== n;
            });
    ...
    var Vv = (function EN(r, o) {
        ...
        function i(o, e) {
            return b(
                ...
                function(e, t) {
                    const n = ve(o, t);
                    const r = n === undefined ? 0 : parseInt(n, 10);
    ...
    var Uv = function(e, t, n, r) {
        const o = bt.fromDom(e.getBody());
        const i = bt.fromDom(e.getDoc());
        !(function(e) {
            e.dom().offsetWidth;
        })(o);
        const a = Ti(i).top();
        const u = ev(bt.fromDom(n.startContainer), n.startOffset);
        t(i, a, u, r), u.cleanup();
    };
    ...
    const Wv = function(e, t, n) {
        ...
        if (i.caretPositionFromPoint)
            ...
            try {
                ...
                r = (function(e, n, t) {
                    ...
                    if (
                        ...
                        (r && r.tagName !== 'HTML') || (r = t.body),
                        o.moveToElementText(r),
                        (i = (i = Rn.toArray(o.getClientRects())).sort(function(
                            e,
                            t,
                        ) {
                            return (
                                (e = Math.abs(
                                    Math.max(e.top - n, e.bottom - n),
                                )) -
                                (t = Math.abs(
                                    Math.max(t.top - n, t.bottom - n),
                                ))
                            );
                        })).length > 0)
                    ) {
            ...
            return (function(e, t) {
                const n = e && e.parentElement ? e.parentElement() : null;
    ...
    const Kv = function(n, e) {
        return X(e, function(e) {
            const t = n.fire('GetSelectionRange', { range: e });
            return t.range !== e ? t.range : e;
        });
    };
    const Xv = be('element', 'width', 'rows');
    var Yv = be('element', 'cells');
    var Gv = be('x', 'y');
    var Jv = function(e) {
        const o = Xv(Ta(e), 0, []);
        return (
    ...
    var Qv = function(e) {
        return (function(e, t) {
            const n = Ta(e.element());
            const r = bt.fromTag('tbody');
            return Ei(r, t), _i(n, r), n;
        })(
            e,
            (function(e) {
                return X(e.rows(), function(e) {
                    const t = X(e.cells(), function(e) {
                        const t = Aa(e);
        ...
        return pv(n, e).bind(function(t) {
            return pv(n, r).map(function(e) {
                return (function(e, t, n) {
                    ...
                    const i = n.x();
                    const a = n.y();
                    const u = o < a ? vv(e, r, o, i, a) : vv(e, r, a, i, o);
    ...
    const iy = function(e, t) {
        ...
        return n.length > 0
            ? Sv(e, n)
            : (function(e, t) {
                  return t.length > 0 && t[0].collapsed ? Ev() : Nv(e, t[0]);
              })(e, t);
    };
    const ay = function(e, t) {
        ...
        const n = (function(e, t) {
            let n;
            const r = e.selection.getRng();
            const o = e.dom.create('body');
            const i = e.selection.getSel();
            const a = Kv(e, ey(i));
            return (
                (n = t.contextual
    ...
    const sy = function(e, t, n) {
        if (
            ...
            const r = e.selection.getRng();
            !(function(r, e) {
                const t = k.from(e.firstChild).map(bt.fromDom);
                const n = k.from(e.lastChild).map(bt.fromDom);
    ...
    function fy(u, s, e, c) {
        ...
        let l;
        let f;
        const i = (function p(i, n) {
            let a;
            let u;
            return {
                selectorChangedWithUnbind(e, t) {
                    return (
                        a ||
                            ((a = {}),
                            (u = {}),
                            n.on('NodeChange', function(e) {
                                const n = e.element;
                                const r = i.getParents(n, null, i.getRoot());
                                const o = {};
        ...
        var h = function() {
            ...
            let o;
            if (!s) return null;
            if ((o = s.document) == null) return null;
            ...
            return (
                (n =
                    ...
                    (o.createRange
                        ? o.createRange()
                        : o.body.createTextRange())).setStart &&
                    n.startContainer.nodeType === 9 &&
                    n.collapsed &&
                    ((r = u.getRoot()), n.setStart(r, 0), n.setEnd(r, 0)),
                l &&
                    f &&
                    (e(n.START_TO_START, n, l) === 0 &&
                    e(n.END_TO_END, n, l) === 0
                        ? (n = f)
                        : (f = l = null)),
                n
            );
            ...
            if (
                (function(e) {
                    return (
                        !!e &&
                        (!!cy(e) ||
                            (ly(e.startContainer) && ly(e.endContainer)))
                    );
                })(e)
            ) {
                const o = cy(e) ? e : null;
                if (o) {
                    ...
                    if (
                        ...
                        !1 === t &&
                            ...
                            (l = n.rangeCount > 0 ? n.getRangeAt(0) : null);
                    }
                    e.collapsed ||
                        e.startContainer !== e.endContainer ||
                        !n.setBaseAndExtent ||
        ...
        var g = {
            ...
            getSelectedBlocks(e, t) {
                return (function(e, t, n, r) {
                    ...
                    if (
                        ((i = e.getRoot()),
                        (n = e.getParent(
                            n || Bv(i, t, t.collapsed),
                            e.isBlock,
                        )),
                        (r = e.getParent(
                            r || Hv(i, t, t.collapsed),
                            e.isBlock,
                        )),
                        n && n !== i && a.push(n),
                        n && r && n !== r)
            ...
            getScrollContainer() {
                for (var e, t = u.getRoot(); t && t.nodeName !== 'BODY'; ) {
        ...
        return e
            ? (function(e) {
                  if (jy(e.previousSibling))
                      return (
                          hy(e.previousSibling) ||
                              e.previousSibling.appendData(lu),
                          e.previousSibling
                      );
    ...
    function Cy(e, t, n) {
        const r = Xy.normalizeForwards(n);
        const o = by(t, r.container());
    ...
    function zy(e, t, n) {
        const r = Xy.normalizeBackwards(n);
        return xy(e, t, r).bind(function(e) {
            return Lc.prevPosition(e, r).isNone()
                ? k.some(Gy.start(e))
                : k.none();
        });
    }
    function Ey(e, t, n) {
        const r = Xy.normalizeForwards(n);
        return xy(e, t, r).bind(function(e) {
            return Lc.nextPosition(e, r).isNone()
                ? k.some(Gy.end(e))
                : k.none();
        });
    }
    ...
    function _y(e, t, n, r) {
        const o = Xy.normalizePosition(e, r);
        const i = ky(t, n, o);
        return ky(t, n, o)
            .bind(d(Dy, e))
            .orThunk(function() {
                return (function(t, n, r, o, e) {
                    const i = Xy.normalizePosition(t, e);
    ...
    var Xy = {
        ...
        isRtl(e) {
            return (
                Yi.DOM.getStyle(e, 'direction', !0) === 'rtl' ||
                (function(e) {
                    return Ky.test(e);
                })(e.textContent)
            );
    ...
    const Qy = ky;
    const Zy = _y;
    const eb = (d(_y, !1), d(_y, !0), Ay);
    const tb = function(e) {
        return e.fold(Gy.start, Gy.start, Gy.end, Gy.end);
    };
    var nb = function(e, t) {
        const n = t.selection.getRng();
        const r = e ? _s.fromRangeEnd(n) : _s.fromRangeStart(n);
        return (
            !!Oy(t) &&
            (e && Ba(r)
                ? By(!0, t.selection, r)
        ...
        move(e, t, n) {
            return function() {
                return (
                    ...
                    (function(t, n, e) {
                        const r = t.getBody();
                        const o = _s.fromRangeStart(t.selection.getRng());
                        const i = d(Xy.isInlineTarget, t);
                    ...
                    Py(t) &&
                        ...
                        (function(e, t) {
                            if (
                                ...
                                const n = _s.fromRangeStart(
                                    e.selection.getRng(),
                                );
                                _s.isTextPosition(n) &&
                                    !1 === Xy.isAtZwsp(n) &&
                                    (Hy(e, $s.removeAndReposition(t.get(), n)),
                                    t.set(null));
                            }
                        })(t, n),
                        (function(n, r, o, e) {
    ...
    function ib(e, t, n, r) {
        for (
            ...
            f &&
            ((s = l), (c = f), (o = t === Rs.Forwards ? s.next(c) : s.prev(c)));
    ...
    function cb(e, t, n, r) {
        ...
        const s = ks(e, t.getBody(), r);
        if (i(s)) return tm(t, s.getNode(!o));
        const c = Xy.normalizePosition(o, n(s));
    ...
    function lb(e, t, n, r) {
        ...
        if (d) {
            ...
            if ((u = Wh(y(h, Uh(1)), c)))
                return rm(t, u.position.toRange(), !0);
            if ((u = Tn.last(y(h, Uh(0)))))
                return rm(t, u.position.toRange(), !0);
        }
    }
    function fb(e, t, n) {
        let r;
        let o;
        const i = oc(e.getBody());
        const a = d(As, i.next);
        const u = d(As, i.prev);
        if (n.collapsed && e.settings.forced_root_block) {
            if (!(r = e.dom.getParent(n.startContainer, 'PRE'))) return;
            (t === 1 ? a(_s.fromRangeStart(n)) : u(_s.fromRangeStart(n))) ||
                ((o = (function(e) {
                    const t = e.dom.create(gf(e));
                    return (
                        (!Sn.ie || Sn.ie >= 11) &&
                            (t.innerHTML = '<br data-mce-bogus="1">'),
                        t
    ...
    function db(t, n) {
        return function() {
            const e = (function(e, t) {
                let n;
                const r = oc(e.getBody());
                const o = d(As, r.next);
                const i = d(As, r.prev);
                const a = t ? Rs.Forwards : Rs.Backwards;
                const u = t ? o : i;
    ...
    function mb(n, r) {
        return function() {
            ...
            const t = r ? lx(n.getBody(), e) : cx(n.getBody(), e);
    ...
    function gb(e, t, n, r, o) {
        const i = ga(bt.fromDom(n), 'td,th,caption').map(function(e) {
            return e.dom();
        });
            ...
            return b(
                ...
                function(e, r) {
                    return e.fold(
                        ...
                        function(e) {
                            const t = Math.sqrt(
                                Math.abs(e.x - o) + Math.abs(e.y - i),
                            );
                            const n = Math.sqrt(
                                Math.abs(r.x - o) + Math.abs(r.y - i),
                            );
    ...
    function bb(e, t, n) {
        const r = e(t, n);
        return (function(e) {
            return e.breakType === Fy.Wrap && e.positions.length === 0;
        })(r) ||
            (!Ge.isBr(n.getNode()) &&
                (function(e) {
                    return e.breakType === Fy.Br && e.positions.length === 1;
                })(r))
            ? !(function(t, n, e) {
                  return e.breakAt
                      .map(function(e) {
    ...
    function wb(e, t) {
        const n = t.getNode(e);
        return Ge.isElement(n) && n.nodeName === 'TABLE' ? k.some(n) : k.none();
    }
    function xb(n, r, o) {
        const e = wb(!!r, o);
        const i = !1 === r;
                            ...
                            return (function(n, r, o, e) {
                                ...
                                i
                                    ? r.undoManager.transact(function() {
                                          const e = bt.fromTag(i);
                                          me(e, pf(r)),
                                              _i(e, bt.fromTag('br')),
                                              n
                                                  ? xi(bt.fromDom(o), e)
                                                  : wi(bt.fromDom(o), e);
                                          const t = r.dom.createRng();
                                          t.setStart(e.dom(), 0),
                                              t.setEnd(e.dom(), 0),
                                              yb(r, t);
                                      })
    ...
    function Ab(e, t, n, r) {
        return t === ''
            ? (function(e, t) {
                  const n = bt.fromTag('br');
                  return Tb(e, n, t), kb(n);
              })(e, r)
            : (function(e, t, n, r) {
                  const o = bt.fromTag(n);
                  const i = bt.fromTag('br');
    ...
    function Bb(e, t) {
        const n = bt.fromDom(e);
        const r = bt.fromDom(t.container());
    ...
    function Vb(e, t, n, r) {
        ...
        (function(e) {
            ...
            Tg(t) &&
            wi(r, bt.fromTag('br'));
        const o = Lc.prevPosition(n.dom(), _s.before(r.dom()));
        return (
            z(Pb(t), function(e) {
                wi(r, e);
            }),
    ...
    function Ib(e, t, n) {
        ...
        const r = Lc.lastPositionIn(n.dom());
        return (
            z(Pb(t), function(e) {
                _i(n, e);
            }),
    ...
    function jb(e, t, n) {
        return (
            Ub(!0, t), Ub(!1, n), Fb(t, n).fold(d(Ib, e, t, n), d(Vb, e, t, n))
        );
    }
    function qb(e, t) {
        const n = bt.fromDom(t);
        const r = d(ze, e);
        return ba(n, Wn, r).isSome();
    }
    function $b(e, t) {
        const n = Lc.prevPosition(e.dom(), _s.fromRangeStart(t)).isNone();
        const r = Lc.nextPosition(e.dom(), _s.fromRangeEnd(t)).isNone();
        return (
            !(function(e, t) {
    ...
    function Xb(e, t, n) {
        const r = y(dh(bt.fromDom(n.container()), t), In);
        const o = E(r).getOr(t);
    ...
    function tC(t, n) {
        ...
        return eC(t, e)
            ...
            .fold(
                function() {
                    return (function(e, t, n) {
                        const r = Ns(t ? 1 : -1, e, n);
                        const o = _s.fromRangeStart(r);
                        const i = bt.fromDom(e);
                        return !1 === t && Vh(o)
                                ...
                                (function(n, r) {
                                    return function(e) {
                                        const t = r
                                            ...
                                            : _s.after(e);
                                        return (
                                            n.selection.setRng(t.toRange()), !0
                                        );
                                    };
                                })(t, n),
                                (function(t) {
                                    return function(e) {
                                        return (
                                            t.selection.setRng(e.toRange()), !0
                                        );
                                    };
                                })(t),
                            );
    ...
    function rC(e, t, n, r, o, i) {
        const a = em(r, e, i.getNode(!o), o, !0);
        if (t.collapsed) {
    ...
    function iC(e, t, n, r) {
        const o = e.getBody();
        const i = d(Xy.isInlineTarget, e);
        e.undoManager.ignore(function() {
            e.selection.setRng(
                (function(e, t) {
                    const n = j.document.createRange();
                    return (
                ...
                Qy(i, o, _s.fromRangeStart(e.selection.getRng()))
                    .map(tb)
                    .map(oC(e, t));
        }),
            e.nodeChanged();
    ...
    function aC(n, r, o, i) {
        ...
        return s
            ...
            .map(oC(n, r))
            .getOrThunk(function() {
                const t = Lc.navigate(o, a, i);
                const e = t.bind(function(e) {
                    return Qy(u, a, e);
                });
                              ...
                              return (
                                  !!(function(o) {
                                      return Ga(
                                          ...
                                          Lc.lastPositionIn(o),
                                          function(e, t) {
                                              const n = Xy.normalizePosition(
                                                  !0,
                                                  e,
                                              );
                                              const r = Xy.normalizePosition(
                                                  !1,
                                                  t,
                                              );
    ...
    function uC(e) {
        return Re(e).length === 1;
    }
    function sC(e, t, n, r) {
        const o = d($m, t);
        const i = X(y(r, o), function(e) {
            return e.dom();
        });
        if (i.length === 0) Ag(t, e, n);
        else {
            const a = (function(e, t) {
                const n = Lm(!1);
                const r = jm(t, n.dom());
    ...
    function cC(n, r) {
        const e = bt.fromDom(n.getBody());
        const t = bt.fromDom(n.selection.getStart());
        const o = y(
            (function(e, t) {
                const n = dh(t, e);
        ...
        return N(o)
            .map(function(e) {
                const t = _s.fromRangeStart(n.selection.getRng());
                return (
                    !(
                        !Ex(r, t, e.dom()) ||
                        (function(e) {
    ...
    function pC(n, e) {
        const t = fC(e.startContainer, n);
        const r = fC(e.endContainer, n);
        return e.collapsed
            ? k.none()
            : Ga(t, r, lC).fold(
                  function() {
    ...
    function yC(e, t) {
        ...
        return (function(e, t) {
            const n = fC(e.startContainer, t);
            const r = fC(e.endContainer, t);
            return Ga(n, r, lC)
                .filter(hC)
                .filter(function(e) {
                    return Vx(t, e);
        ...
        return Lc.navigate(r, t.getBody(), i)
            .bind(function(e) {
                return (function(e, n, r, o) {
                    ...
                    : (function(e, t, n) {
                          return Ix(e, bt.fromDom(n.getNode())).map(function(
                              e,
                          ) {
                              return !1 === ze(e, t);
                          });
        ...
        return NC(r, e)
            .bind(function(e) {
                return Tg(e)
                    ? Fx(t, e)
                    : (function(e, t, n, r, o) {
                          return Lc.navigate(n, e.getBody(), o).bind(function(
                              e,
                          ) {
                              return NC(t, bt.fromDom(e.getNode())).map(
                                  function(e) {
                                      return !1 === ze(e, r);
                                  },
                              );
        ...
        return Ix(r, e).fold(
            function() {
                return (
                    kC(t, n, r, e) ||
                    (function(e, t) {
                        const n = _s.fromRangeStart(e.selection.getRng());
                        return (
                            TC(t, n) ||
            ...
            function(e) {
                return (function(e, t, n, r) {
                    const o = _s.fromRangeStart(e.selection.getRng());
                ...
                (function(r, e) {
                    return w(e, function(e) {
                        ...
                        const n = ye(e, t)
                            ...
                            .getOr(0);
                        return (
                            r.dom.getContentEditable(e.dom()) !== 'false' &&
                            n > 0
                        );
                    });
                })(e, t))
    ...
    function XC(e, t) {
        ...
        let r;
        const o = e.getRoot();
        for (n = t; n !== o && e.getContentEditable(n) !== 'false'; )
            e.getContentEditable(n) === 'true' && (r = n), (n = n.parentNode);
        return n !== o ? r : o;
    }
    function YC(e, t) {
        const n = gf(e);
    ...
    function QC(e, t) {
        ...
        let u = a.startOffset;
        let s = a.startContainer;
        if (s.nodeType === 1 && s.hasChildNodes()) {
            const c = u > s.childNodes.length - 1;
            (s = s.childNodes[Math.min(u, s.childNodes.length - 1)] || s),
                (u = c && s.nodeType === 3 ? s.nodeValue.length : 0);
        }
        let l = i.getParent(s, i.isBlock);
        const f = l ? i.getParent(l.parentNode, i.isBlock) : null;
        const d = f ? f.nodeName.toUpperCase() : '';
        const h = !(!t || !t.ctrlKey);
        d !== 'LI' || h || (l = f),
            s &&
                s.nodeType === 3 &&
    ...
    function tw(e) {
        return e && e.nodeName === 'A' && 'href' in e;
    }
    function nw(e) {
    ...
    function ow(e, t) {
        return Zx(e)
            .filter(function(e) {
                return t.length > 0 && we(bt.fromDom(e), t);
            })
            .isSome();
    }
    function iw(e, t) {
    ...
    function hw(e) {
        const t = gf(e);
        const n = Qx(e.dom, e.selection.getStart());
    ...
    function gw(n, r) {
        ...
        return Ge.isText(e)
            ...
            : Ts(r).map(function(e) {
                  const t = bt.fromText(n);
                  return (
                      r.isAtEnd() ? xi(e, t) : wi(e, t), ju(t.dom(), n.length)
                  );
              });
    }
    function pw(e) {
    ...
    function vw(e, t) {
        const n = y(dh(bt.fromDom(t.container()), e), In);
        return E(n).getOr(e);
    }
    function yw(e, t) {
        return pw(t)
    ...
    function Mw(e) {
        const t = _s.fromRangeStart(e.selection.getRng());
        const n = bt.fromDom(e.getBody());
        if (e.selection.isCollapsed()) {
            const r = d(Xy.isInlineTarget, e);
            const o = _s.fromRangeStart(e.selection.getRng());
    ...
    function Dw(e, t) {
        ...
        if (n)
            return t.type === 'compositionstart'
    ...
    function Ow(a) {
        ...
        function n() {
            a.on('keydown', function(e) {
                if (
                    ...
                    e.keyCode === i &&
                    l.isCollapsed() &&
                    l.getRng().startOffset === 0
                ) {
                    const t = l.getNode().previousSibling;
            ...
            a.inline ||
                ...
                a.on('click', function(e) {
                    ...
                    if (e.target.nodeName === 'HTML') {
                        if (Sn.ie > 11) return void a.getBody().focus();
        ...
        const m = Sn.ie;
        const g = Sn.webkit;
        const p = 'data:text/mce-internal,';
        const v = m ? 'Text' : 'URL';
        function y(e) {
            const t = c.create('body');
            const n = e.cloneContents();
            return (
                t.appendChild(n), l.serializer.serialize(t, { format: 'html' })
            );
        }
        function b() {
            const e = c.getAttribs(l.getStart().cloneNode(!1));
            return function() {
                const t = l.getStart();
                t !== a.getBody() &&
        ...
        return (
            ...
            g &&
                ...
                a.on('click', function(e) {
                    ...
                    /^(IMG|HR)$/.test(t.nodeName) &&
                        c.getContentEditableParent(t) !== 'false' &&
                        (e.preventDefault(),
                        a.selection.select(t),
                        a.nodeChanged()),
                        t.nodeName === 'A' &&
                ...
                d.addNodeFilter('br', function(e) {
                    for (let t = e.length; t--; )
                        e[t].attr('class') === 'Apple-interchange-newline' &&
                            e[t].remove();
                }),
                Sn.iOS
                    ? (a.inline ||
                    ...
                    !(function(e) {
                        ...
                        e.dataTransfer &&
                            (a.selection.isCollapsed() &&
                                ...
                                l.select(e.target),
                            (t = a.selection.getContent()).length > 0 &&
            ...
            h &&
                (a.on('keydown', function(e) {
                    if (!u(e) && e.keyCode === i) {
                        if (!a.getBody().getElementsByTagName('hr').length)
                            return;
                        if (l.isCollapsed() && l.getRng().startOffset === 0) {
                            const t = l.getNode();
                ...
                a.on('keypress', function(e) {
                    let t;
                    if (!u(e) && (e.keyCode === 8 || e.keyCode === 46) && C())
                        return (
                            (t = b()),
        ...
        t.on('click', function(e) {
            e.detail >= 3 &&
                (function(e) {
                    ...
                    const n = ju.fromRangeStart(t);
                    const r = ju.fromRangeEnd(t);
    ...
    function Vw(e, t) {
        ...
        const o = (function(e, t) {
            if (
                ...
                const r = `javascript:(function(){document.open();document.domain="${j.document.domain}";var ed = window.parent.tinymce.get("${e.id}");document.write(ed.iframeHTML);document.close();ed.${n}(true);})()`;
        ...
        return (
            ...
            (e.iframeHTML = (function(e) {
                ...
                return (
                    ...
                    (n = df(e)),
                    hf(e) &&
                        (r += `<meta http-equiv="Content-Security-Policy" content="${hf(
                            e,
                        )}" />`),
    ...
    function Iw(e) {
        e.contentCSS = e.contentCSS.concat(
            (function(t) {
                const e = Vf(t);
                const n = `${t.editorManager.baseURL}/skins/content`;
                const r = `content${t.editorManager.suffix}.css`;
                const o = !0 === t.inline;
                return X(e, function(e) {
                    return (function(e) {
    ...
    function Ww(e, t) {
        ...
        !(function(e, t, n, r) {
            ...
            !(function(e, t) {
                const n = Bf(t);
                const r = Hf(t);
                if (!1 === oa.hasCode(n) && n !== 'en') {
                    const o =
                        r !== ''
                            ? r
                            : `${t.editorManager.baseURL}/langs/${n}.js`;
    ...
    function Zw(e, t) {
        ...
        n.collapsed &&
            (function(e, t) {
                return Ge.isText(e) && e.nodeValue[t - 1] === '\xa0';
            })(r, o) &&
            Ge.isText(r) &&
            (r.insertData(o - 1, ' '),
            r.deleteData(o, 1),
    ...
    function ex(e, t, n) {
        ...
        if (
            ...
            (t = s.content).indexOf('{$caret}') === -1 && (t += '{$caret}'),
                (t = t.replace(/\{\$caret\}/, d));
            const p =
            ...
            if (
                ((u = r.parse(t, y)),
                !0 === n.paste && Tz(e.schema, u) && Mz(g, i))
            )
                return (
            ...
            if (
                ((function(e) {
                    for (let t = e; (t = t.walk()); )
                        t.type === 1 && t.attr('data-mce-fragment', '1');
                })(u),
                (f = u.lastChild).attr('id') === 'mce_marker')
            )
                for (f = (c = f).prev; f; f = f.walk(!0))
                    if (f.type === 3 || !g.isBlock(f.name)) {
                        e.schema.isValidChild(f.parent.name, 'span') &&
                            f.parent.insert(c, f, f.name === 'br');
                        break;
                    }
            ...
            !(function(e, t) {
                ...
                (function(n, e) {
                    ...
                    if (e) {
                        if (
                            ...
                            (t = (function(e) {
                                for (
                                    ...
                                    if (n.dom.getContentEditable(e) === 'false')
                                        return e;
                                return null;
                            })(e)))
                        )
                        ...
                        let c = u.createRng();
                        (i = e.previousSibling) && i.nodeType === 3
                        ...
                        (r = u.getParent(e, u.isBlock)),
                            ...
                            r &&
                                ...
                                !(o = (function(e) {
                                    let t = _s.fromRangeStart(e);
                                    if ((t = oc(n.getBody()).next(t)))
                                        return t.toRange();
                                })(c))
                                    ? u.add(
                                          r,
    ...
    function ax(t) {
        return k.from(t.selection.getRng()).bind(function(e) {
            return (function(e, t) {
                return e.startContainer === t && e.startOffset === 0;
            })(e, t.getBody())
                ? k.none()
    ...
    var lx = d(ib, ju.isBelow, 1);
    var fx = d(ab, -1, cx);
    var dx = d(ab, 1, lx);
    var hx = Ge.isContentEditableFalse;
    var mx = Ka;
    var gx = d(
        gb,
        function(e) {
    ...
    var Ex = function(i, a, u) {
        return Ga(Lc.firstPositionIn(u), Lc.lastPositionIn(u), function(e, t) {
            const n = Xy.normalizePosition(!0, e);
            const r = Xy.normalizePosition(!1, t);
            const o = Xy.normalizePosition(!1, a);
            return i
                ? Lc.nextPosition(u, o)
                      .map(function(e) {
    ...
    var Sx = function(e, t, n, r) {
        return t ? jb(e, r, n) : jb(e, n, r);
    };
    const kx = function(t, n) {
        const r = bt.fromDom(t.getBody());
        const e = Nx(r.dom(), n, t.selection.getRng()).bind(function(e) {
    ...
    const Ox = function(e) {
        let t;
        const n = Dx(e.getBody(), e.selection.getNode());
        return (
    ...
    const Bx = function(e, t) {
        return (function(e, t) {
            ...
            const r = t ? Rs.Forwards : Rs.Backwards;
            const o = oc(e.getBody());
            const i = d(As, o.next);
            const a = d(As, o.prev);
            const u = t ? i : a;
            const s = t ? Lh : Vh;
            const c = ks(r, e.getBody(), n);
            const l = Xy.normalizePosition(t, u(c));
    ...
    const Hx = function(e, t, n) {
        if (
            ...
            const r = _s.fromRangeStart(e.selection.getRng());
            return aC(e, t, n, r);
        }
        return !1;
    };
    const Px = function(e, t) {
        return !!e.selection.isCollapsed() && cC(e, t);
    };
    var Lx = qf([{ removeTable: ['element'] }, { emptyCells: ['cells'] }]);
    var Vx = function(e, t) {
    ...
    const Ux = function(e, t) {
        const n = bt.fromDom(e.selection.getStart(!0));
        const r = oy(e);
        return e.selection.isCollapsed() && r.length === 0
            ? AC(e, t, n)
            : (function(e, t) {
                  const n = bt.fromDom(e.getBody());
                  const r = e.selection.getRng();
                  const o = oy(e);
                  return o.length !== 0 ? wC(e, o) : EC(e, n, r, t);
              })(e, n);
    };
    const jx = function(e, t) {
        return (
            !!e.selection.isCollapsed() &&
            (function(t, n) {
                const e = _s.fromRangeStart(t.selection.getRng());
    ...
    var Kx = d(PC, !1);
    var Xx = d(PC, !0);
    const Yx = function(e, t, n) {
        if (e.selection.isCollapsed() && DC(e)) {
            const r = e.dom;
            const o = e.selection.getRng();
            const i = _s.fromRangeStart(o);
            const a = r.getParent(o.startContainer, r.isBlock);
            if (a !== null && $x(bt.fromDom(a), i)) return OC(e, 'outdent'), !0;
        }
        return !1;
    };
    const Gx = function(t, n) {
        t.on('keydown', function(e) {
            !1 === e.isDefaultPrevented() &&
                (function(e, t, n) {
                    Cx(
    ...
    const Jx = function(e, t) {
        ...
        let o = t;
        const i = e.dom;
        const a = e.schema.getMoveCaretBeforeOnEnterElements();
        if (t) {
            ...
            if (((r = i.createRng()), t.normalize(), t.hasChildNodes())) {
                for (let s = new bi(t, t); (n = s.current()); ) {
                    if (Ge.isText(n)) {
    ...
    const rz = function(a, e) {
        function t(e) {
            let t;
            let n;
            let r;
            let o = s;
            const i = b.getTextInlineElements();
            if (
                (e || m === 'TABLE' || m === 'HR'
        ...
        function n(e) {
            ...
            let n;
            const r = KC(e, s, i);
            if (Ge.isText(s) && (e ? r > 0 : r < s.nodeValue.length)) return !1;
            ...
            for (
                ...
                if (Ge.isElement(t)) {
                    if (
                        ...
                        ((n = t.nodeName.toLowerCase()), C[n] && n !== 'br')
                    )
                        return !1;
                } else if (Ge.isText(t) && !/^[ \t\r\n]*$/.test(t.nodeValue))
                    return !1;
        ...
        function r() {
            (f =
                /^(H[1-6]|PRE|FIGURE)$/.test(m) && g !== 'HGROUP' ? t(p) : t()),
        ...
        var y = a.dom;
        var b = a.schema;
        var C = b.getNonEmptyElements();
        const w = a.selection.getRng();
                ...
                (((p && !l) || (!p && l)) &&
                    (s = (function(e, t, n, r, o) {
                        ...
                        if (!(a = d.getParent(r, d.isBlock)) || !WC(d, a)) {
                            ...
                            if (
                                u &&
                                e.schema.isValidChild(l, f.toLowerCase())
                            ) {
                                for (
                                    i = d.create(f),
                                        YC(e, i),
    ...
    const mz = function(t) {
        t.on('keydown', function(e) {
            !1 === e.isDefaultPrevented() &&
                (function(e, t) {
                    Cx([{ keyCode: Mh.SPACEBAR, action: bx(Mw, e) }], t).each(
                        function(e) {
                            t.preventDefault();
                        },
                    );
    ...
    const yz = function(e) {
        const t = rb.setupSelectedState(e);
    ...
    var Cz = function(t, e) {
        ...
        o.inline || (t.getElement().style.visibility = t.orgVisibility),
            ...
            t.readonly ||
                (t.inline &&
                    bz.getStyle(n, 'position', !0) === 'static' &&
            ...
            (t.parser = (function(u) {
                const e = Sp(u.settings, u.schema);
                return (
                    e.addAttributeFilter('src,href,style,tabindex', function(
                        e,
                        t,
                    ) {
            ...
            o.browser_spellcheck ||
                o.gecko_spellcheck ||
                ((a.body.spellcheck = !1),
                bz.setAttrib(n, 'spellcheck', 'false')),
            (t.quirks = Ow(t)),
            t.fire('PostRender');
        const u = If(t);
        u !== undefined && (n.dir = u),
            ...
            t.on('compositionstart compositionend', function(e) {
                t.composing = e.type === 'compositionstart';
            }),
            t.contentStyles.length > 0 &&
                ((r = ''),
            ...
            o.content_style &&
                (function(e, t) {
                    const n = bt.fromDom(e.getDoc().head);
                    const r = bt.fromTag('style');
                    At(r, 'type', 'text/css'), _i(r, bt.fromText(t)), _i(n, r);
                })(t, o.content_style);
    };
    var wz = Yi.DOM;
    const xz = function(e, t) {
        const n = Vw(e, t);
        t.editorContainer &&
    ...
    var zz = Yi.DOM;
    var Ez = function(t, n, e) {
        const r = Wd.get(e);
        const o = Wd.urls[e] || t.documentBaseUrl.replace(/\/$/, '');
        if (((e = Rn.trim(e)), r && Rn.inArray(n, e) === -1)) {
            if (
    ...
    var Nz = function(e) {
        e.fire('ScriptsLoaded'),
            (function(n) {
                const e = Rn.trim(n.settings.icons);
                const r = n.ui.registry.getAll().icons;
                const t = {
                    'accessibility-check':
        ...
        const t = (function(e) {
            ...
            return (
                ...
                K(e.settings.theme)
                    ...
                    ? (function(e) {
                          const t = e.getElement();
                          const n = (0, e.settings.theme)(e, t);
                          return (
    ...
    const kz = function(t) {
        ...
        if (Tr.Event.domLoaded) {
            if (t.getElement() && Sn.contentEditable) {
                ...
                const o = t.getElement().form || Sz.getParent(n, 'form');
                o &&
                    ((t.formElement = o),
                    e.hidden_input &&
    ...
    var Tz = function(e, t) {
        ...
        return (
            ...
            r && r.attr('id') === 'mce_marker' && (r = r.prev),
            (function(e, t) {
            ...
            !(!n || n !== r) && (n.name === 'ul' || n.name === 'ol')
        );
    };
    var Az = function(e, o, i, t) {
        function n(e) {
            const t = _s.fromRangeStart(i);
            const n = oc(o.getRoot());
            const r = e === 1 ? n.prev(t) : n.next(t);
            return !r || Gw(o, r.getNode()) !== a;
        }
        const r = (function(e, t, n) {
            const r = t.serialize(n);
            return (function(e) {
        ...
        var a = Gw(o, i.startContainer);
        const u = Yw(Kw(r.firstChild));
        const s = o.getRoot();
        return n(1)
            ? Qw(a, u, s)
            : n(2)
    ...
    var Rz = Ge.matchNodeNames(['td', 'th']);
    ...
    var Bz = { 'font-size': 'size', 'font-family': 'face' };
    const Hz = {
    ...
    const Iz =
        ...
        (Fz.prototype.setupCommands = function(i) {
            ...
            function e(n) {
                return function() {
                    const e = i.selection.isCollapsed()
                        ? [
                              i.dom.getParent(
                                  i.selection.getNode(),
                                  i.dom.isBlock,
            ...
            this.addCommands({
                ...
                'Cut,Copy,Paste': function(e) {
                    ...
                    if (
                        (e !== 'paste' || n.queryCommandEnabled(e) || (t = !0),
                ...
                unlink() {
                    if (i.selection.isCollapsed()) {
                        const e = i.dom.getParent(i.selection.getStart(), 'a');
                        e && i.dom.remove(e, !0);
                ...
                mceCleanup() {
                    const e = i.selection.getBookmark();
                    i.setContent(i.getContent()), i.selection.moveToBookmark(e);
                },
                mceRemoveNode(e, t, n) {
                    const r = n || i.selection.getNode();
                    r !== i.getBody() &&
                        (a.storeSelection(),
                        i.dom.remove(r, !0),
                        a.restoreSelection());
                },
                mceSelectNodeDepth(e, t, n) {
                    let r = 0;
                    i.dom.getParent(
                        i.selection.getNode(),
                        function(e) {
                ...
                mceInsertContent(e, t, n) {
                    Dz(i, n);
                },
                mceInsertRawHTML(e, t, n) {
                    i.selection.setContent('tiny_mce_marker');
                    const r = i.getContent();
                    i.setContent(
                ...
                mceInsertNewLine(e, t, n) {
                    lz(i, n);
                },
                mceToggleFormat(e, t, n) {
                    a.toggleFormat(n);
                },
                mceSetContent(e, t, n) {
                    i.setContent(n);
                ...
                selectAll() {
                    const e = i.dom.getParent(
                        i.selection.getStart(),
                        Ge.isContentEditableTrue,
                    );
                    if (e) {
                        const t = i.dom.createRng();
    ...
    const jz =
        ...
        (qz.prototype.has = function(e) {
            return (
                (e = e.toLowerCase()),
                !(!this.bindings[e] || this.bindings[e].length === 0)
            );
        }),
        qz);
    function qz(e) {
    ...
    function Qz(e, t) {
        return t === 'selectionchange'
            ...
            ? (e.eventRoot ||
                  (e.eventRoot = aE.select(e.settings.event_root)[0]),
              e.eventRoot)
            : e.getBody();
    }
    function Zz(e, t, n) {
            ...
            ? Gz(e) &&
              (function(e, t) {
                  ...
                  !(function(e) {
                      ...
                      Mh.metaKeyPressed(t) ||
                      !(function(e, t) {
                          return e.dom.getParent(t, 'a') !== null;
                      })(e, n) ||
                      t.preventDefault();
              })(e, n)
            : e.fire(t, n);
    ...
    const oE = {
        fire(e, t, n) {
            if (this.removed && e !== 'remove' && e !== 'detach') return t;
            const r = $z(this).fire(e, t);
            if (!1 !== n && this.parent)
                for (let o = this.parent(); o && !r.isPropagationStopped(); )
    ...
    var iE = 'data-mce-contenteditable';
    var aE = Yi.DOM;
    const uE = {
        ...oE,
    ...
    const dE = Rn.makeMap('alt,ctrl,shift,meta,access');
    const hE =
        ((mE.prototype.add = function(e, n, r, o) {
            ...
            return (
                ...
                cE(lE(Rn.trim(e)), function(e) {
                    const t = i.createShortcut(e, n, r, o);
                    i.shortcuts[t.id] = t;
                }),
                !0
            );
        ...
        (mE.prototype.parseShortcut = function(e) {
            ...
            return (
                (r.id = t.join(',')),
                r.access &&
                    ((r.alt = !0), Sn.mac ? (r.ctrl = !0) : (r.shift = !0)),
                r.meta &&
                    (Sn.mac ? (r.meta = !0) : ((r.ctrl = !0), (r.meta = !1))),
                r
            );
        }),
        (mE.prototype.createShortcut = function(e, t, n, r) {
            let o;
            return (
                ((o = Rn.map(lE(e, '>'), this.parseShortcut))[
                    o.length - 1
                ] = Rn.extend(o[o.length - 1], {
                    func: n,
                    scope: r || this.editor,
                })),
                Rn.extend(o[0], {
                ...
                (cE(n.shortcuts, function(e) {
                    if (n.matchShortcut(t, e))
                        return (
                            ...
                            t.type === 'keydown' && n.executeShortcutAction(e),
                            !0
                        );
                }),
    ...
    function gE() {
        const e = (function() {
            function e(n, r) {
                return function(e, t) {
                    return (n[e.toLowerCase()] = { ...t, type: r });
                };
            }
            const t = {};
            const n = {};
    ...
    const pE = Rn.each;
    const vE = Rn.trim;
    const yE = 'source protocol authority userInfo user password host port relative path directory file query anchor'.split(
        ' ',
    );
    const bE = { ftp: 21, http: 80, https: 443, mailto: 25 };
    const CE =
        ((wE.parseDataUri = function(e) {
            let t;
            const n = decodeURIComponent(e).split(',');
            const r = /data:([^;]+)/.exec(n[0]);
        ...
        (wE.getDocumentBaseUrl = function(e) {
            ...
            return (
                (t =
                    e.protocol.indexOf('http') !== 0 && e.protocol !== 'file:'
                        ? e.href
        ...
        (wE.prototype.toRelative = function(e) {
            let t;
            if (e === './') return e;
            const n = new wE(e, { base_uri: this });
            if (
                (n.host !== 'mce_host' && this.host !== n.host && n.host) ||
                this.port !== n.port ||
        ...
        (wE.prototype.toRelPath = function(e, t) {
            ...
            let i = 0;
            let a = '';
            const u = e.substring(0, e.lastIndexOf('/')).split('/');
    ...
    function wE(e, t) {
        ...
        if (/^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e)) r.source = e;
            ...
            if (
                ...
                const i = this.settings.base_uri
                ...
                if (
                    ...
                    const a = /([^#?]*)([#?]?.*)/.exec(e);
                    e = `${(n && n.protocol) || 'http'}://mce_host${r.toAbsPath(
                        i,
                        a[1],
                    )}${a[2]}`;
                }
            ...
            pE(yE, function(e, t) {
                ...
                n &&
                    ...
                    r.port || r.host !== 'mce_host' || (r.port = n.port),
                    (r.host && r.host !== 'mce_host') || (r.host = n.host),
                    (r.source = '')),
                o && (r.protocol = '');
        }
    }
    ...
    const kE =
        ...
        (TE.prototype.load = function(e) {
            ...
            if (n) {
                (e = e || {}).load = !0;
                const r = Ge.isTextareaOrInput(n) ? n.value : n.innerHTML;
                return (
        ...
        (TE.prototype.save = function(e) {
            ...
            if (o && r.initialized && !r.removed)
                return (
                    ...
                    e.format === 'raw' && r.fire('RawSaveContent', e),
                    (t = e.content),
        ...
        (TE.prototype.getElement = function() {
            return (
                this.targetElm || (this.targetElm = xE.get(this.id)),
                this.targetElm
            );
        }),
                    ...
                    switch (e.nodeName) {
                        ...
                        case 'A':
                            return void (
                                ...
                                (n =
                                    o.visual_anchor_class || 'mce-item-anchor'),
                                t && r.hasVisual
                                    ? i.addClass(e, n)
                                    : i.removeClass(e, n))
                            );
    ...
    function TE(e, t, n) {
        ...
        (this.plugins = {}),
            ...
            this.settings.referrer_policy &&
                (Zi.ScriptLoader._setReferrerPolicy(
                    this.settings.referrer_policy,
                ),
    ...
    function RE(t) {
        ...
        return (
            ...
            jE.activeEditor === t &&
                (jE.activeEditor = FE.length > 0 ? FE[0] : null),
    ...
    var IE = [];
    var FE = [];
    const UE = j.document.compatMode !== 'CSS1Compat';
    var jE = {
        ...oE,
        baseURI: null,
        baseURL: null,
        ...
        setup() {
            ...
            if (r) (e = r.base || r.baseURL), (n = r.suffix);
                ...
                for (
                    let o = j.document.getElementsByTagName('script'), i = 0;
                    i < o.length;
                    i++
                ) {
                    var a;
                    if ((a = o[i].src || '') !== '') {
                        const u = a.substring(a.lastIndexOf('/'));
                        if (
                            /tinymce(\.full|\.jquery|)(\.min|\.dev|)\.js/.test(
                                a,
                            )
                        ) {
                            u.indexOf('.min') !== -1 && (n = '.min'),
                ...
                if (!e && j.document.currentScript)
                    (a = j.document.currentScript.src).indexOf('.min') !== -1 &&
                        (n = '.min'),
                        (e = a.substring(0, a.lastIndexOf('/')));
            }
        ...
        overrideDefaults(e) {
            ...
            const r = (this.defaultSettings = e).plugin_base_urls;
            for (const o in r) pa.PluginManager.urls[o] = r[o];
        },
        init(r) {
            let n;
            let u;
                ...
                OE.unbind(window, 'ready', e),
                    ...
                    (o = yi.unique(
                        (function(t) {
                            ...
                            switch (t.mode) {
                                case 'exact':
                                    (e = t.elements || '').length > 0 &&
                                        HE(BE(e), function(t) {
                                            let e;
                                            (e = OE.get(t))
                                                ? n.push(e)
                                                : HE(j.document.forms, function(
                                                      e,
                                                  ) {
                                                      HE(e.elements, function(
                                                          e,
                                                      ) {
                                                          e.name === t &&
                                                              ((t = `mce_editor_${LE++}`),
        ...
        remove(e) {
            ...
            } else for (t = FE.length - 1; t >= 0; t--) r.remove(FE[t]);
        },
        execCommand(e, t, n) {
            const r = this.get(n);
            switch (e) {
                case 'mceAddEditor':
                    return (
                        this.get(n) || new kE(n, this.settings, this).render(),
                        !0
                    );
    ...
    const QE =
        ...
        {
            load(r, o) {
                const i = `Script at URL "${o}" failed to load`;
                const a = `Script at URL "${o}" did not call \`tinymce.Resource.add('${r}', data)\` within 1 second`;
    ...
    const rN = {
        ...
        relativePosition: $E,
        findBestRelativePosition(e, t, n, r) {
            let o;
            let i;
    ...
    WE.extend = YE = function(n) {
        ...
        n.Mixins &&
            (oN(n.Mixins, function(e) {
                for (const t in e) t !== 'init' && (n[t] = e[t]);
            }),
        ...
        n.Defaults &&
            u.Defaults &&
            (n.Defaults = iN({}, u.Defaults, n.Defaults)),
        n))
            typeof (a = n[i]) === 'function' && u[i]
                ? (o[i] = e(i, a))
                : (o[i] = a);
    ...
    const lN = {
        ...
        send(t) {
            const n = this;
            const r = Yi.DOM;
            const o = t.count !== undefined ? t.count : n.count;
            const i = `tinymce_jsonp_${o}`;
    ...
    var fN = {
        ...
        send(e) {
            ...
            let n = 0;
            var r = function() {
                !e.async || t.readyState === 4 || n++ > 1e4
                    ? (e.success && n < 1e4 && t.status === 200
                          ? e.success.call(
                                e.success_scope,
                                `${t.responseText}`,
                                t,
            ...
            if (
                ...
                if (
                    ...
                    (t = fN.fire('beforeSend', { xhr: t, settings: e })
                        .xhr).send(e.data),
                    !e.async)
                )
                    return r();
